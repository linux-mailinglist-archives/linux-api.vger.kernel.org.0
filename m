...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0B9A017DFC7
	for <lists+linux-api@lfdr.de>; Mon,  9 Mar 2020 13:18:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726451AbgCIMSL (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Mon, 9 Mar 2020 08:18:11 -0400
Received: from us-smtp-delivery-1.mimecast.com ([205.139.110.120]:56982 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726391AbgCIMSK (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Mon, 9 Mar 2020 08:18:10 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1583756288;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=DrM1zNw04pXWne/+kf0kx/Hemdjx6HltNe8ggVYHosU=;
        b=d45ILTV1IHUxcs3NY25xUentsbh2luNZvmsxnV5tFZUilnzKbUwPzlghmmbBBmv84gmrkl
        2EsJFSbMYZ8QCqjbQxE8RnuZqJ6rvcg63/fk3v0CQE6TI2ol3E7fsZ70TvgsMn5FlqJgy4
        5Bb0ThId82Mxf1BAhShCNeMg1tKk9SA=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-266-d9UX5puUMwqdRQasOELEGg-1; Mon, 09 Mar 2020 08:18:04 -0400
X-MC-Unique: d9UX5puUMwqdRQasOELEGg-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com [10.5.11.13])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id B9A97107ACC9;
        Mon,  9 Mar 2020 12:18:02 +0000 (UTC)
Received: from warthog.procyon.org.uk (ovpn-120-182.rdu2.redhat.com [10.10.120.182])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 3EF1991D8A;
        Mon,  9 Mar 2020 12:17:59 +0000 (UTC)
Organization: Red Hat UK Ltd. Registered Address: Red Hat UK Ltd, Amberley
        Place, 107-111 Peascod Street, Windsor, Berkshire, SI4 1TE, United
        Kingdom.
        Registered in England and Wales under Company Registration No. 3798903
Subject: [RFC PATCH 05/17] pipe: Add general notification queue support [ver
 #4]
...
Date:   Mon, 09 Mar 2020 12:17:58 +0000
Message-ID: <158375627842.334846.15730909810530935429.stgit@warthog.procyon.org.uk>
...
index 5a34d6c22d4c..36eedf8cb143 100644
--- a/fs/pipe.c
+++ b/fs/pipe.c
@@ -24,6 +24,7 @@
...
@@ -753,27 +776,27 @@ pipe_fasync(int fd, struct file *filp, int on)
 	return retval;
 }
...
@@ -795,12 +818,12 @@ struct pipe_inode_info *alloc_pipe_info(void)
...
@@ -812,6 +835,7 @@ struct pipe_inode_info *alloc_pipe_info(void)
...
+		pipe->nr_accounted = pipe_bufs;
 		...
 		return pipe;
@@ -829,7 +853,14 @@ void free_pipe_info(struct pipe_inode_info *pipe)
 {
 	int i;
...
@@ -905,6 +936,17 @@ int create_pipe_files(struct file **res, int flags)
 	if (!inode)
 		return -ENFILE;
...
+
 	f = alloc_file_pseudo(inode, pipe_mnt, "",
 				...
 				&pipefifo_fops);
@@ -935,7 +977,7 @@ static int __do_pipe_flags(int *fd, struct file **files, int flags)
 	int error;
 	int fdw, fdr;
...
@@ -1183,42 +1225,12 @@ unsigned int round_pipe_size(unsigned long size)
 }
...
@@ -1230,17 +1242,13 @@ static long pipe_set_size(struct pipe_inode_info *pipe, unsigned long arg)
 	head = pipe->head;
 	tail = pipe->tail;
...
@@ -1268,15 +1276,67 @@ static long pipe_set_size(struct pipe_inode_info *pipe, unsigned long arg)
 	kfree(pipe->bufs);
 	pipe->bufs = bufs;
...
@@ -1285,9 +1345,17 @@ static long pipe_set_size(struct pipe_inode_info *pipe, unsigned long arg)
...
@@ -1295,7 +1363,7 @@ long pipe_fcntl(struct file *file, unsigned int cmd, unsigned long arg)
...
index d5765039652a..8cd14d72dfd1 100644
...
index cfee56c151f1..92229457dc7f 100644
--- a/init/Kconfig
+++ b/init/Kconfig
