...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5B26A270520
	for <lists+linux-api@lfdr.de>; Fri, 18 Sep 2020 21:23:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726397AbgIRTXI (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Fri, 18 Sep 2020 15:23:08 -0400
Received: from mga18.intel.com ([134.134.136.126]:41777 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726545AbgIRTWw (ORCPT <rfc822;linux-api@vger.kernel.org>);
        Fri, 18 Sep 2020 15:22:52 -0400
IronPort-SDR: um5Oyn1uW0hPPQB39A6BRmOXjsvaIycMSl3YFqxCeLHoUt7+CbZ9wJ4vrXtT/sUPtLp9u34mb5
 +g9dgxO7i93A==
X-IronPort-AV: E=McAfee;i="6000,8403,9748"; a="147766250"
X-IronPort-AV: E=Sophos;i="5.77,274,1596524400"; 
   d="scan'208";a="147766250"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Sep 2020 12:22:23 -0700
IronPort-SDR: 55MEf9bM7DEHNTCvzEfYvJcbySfNdGZxB3SnHW6b3XfdIv3HS/OVPS7c0IV5KAP2R/lH5v53xg
 n3h8IWPLiWXw==
X-IronPort-AV: E=Sophos;i="5.77,274,1596524400"; 
   d="scan'208";a="484331890"
Received: from yyu32-desk.sc.intel.com ([143.183.136.146])
  by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Sep 2020 12:22:22 -0700
...
Subject: [PATCH v12 19/26] mm: Re-introduce do_mmap_pgoff()
Date:   Fri, 18 Sep 2020 12:21:17 -0700
Message-Id: <20200918192125.25473-20-yu-cheng.yu@intel.com>
...
index de6d1f7bac48..febbba1ece6e 100644
--- a/include/linux/mm.h
+++ b/include/linux/mm.h
@@ -2558,13 +2558,23 @@ extern unsigned long mmap_region(struct file *file, unsigned long addr,
 	struct list_head *uf);
