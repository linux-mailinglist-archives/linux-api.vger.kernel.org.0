...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2F75B24B18D
	for <lists+linux-api@lfdr.de>; Thu, 20 Aug 2020 10:56:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725859AbgHTIya (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Thu, 20 Aug 2020 04:54:30 -0400
Received: from mo4-p04-ob.smtp.rzone.de ([85.215.255.122]:17819 "EHLO
        mo4-p04-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726934AbgHTIxj (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Thu, 20 Aug 2020 04:53:39 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1597913590;
        s=strato-dkim-0002; d=chronox.de;
        h=References:In-Reply-To:Message-ID:Date:Subject:Cc:To:From:
        X-RZG-CLASS-ID:X-RZG-AUTH:From:Subject:Sender;
        bh=D7unmhlbz8/v3DmLt/vOdiN/RkCAAFTPEYvMWsMv8hw=;
        b=
X-RZG-AUTH: ":P2ERcEykfu11Y98lp/T7+hdri+uKZK8TKWEqNyiHySGSa9k9xm0dNS3IdRAZAL+p6A=="
X-RZG-CLASS-ID: mo00
Received: from positron.chronox.de
        by smtp.strato.de (RZmta 46.10.7 DYNA|AUTH)
        with ESMTPSA id 002e9aw7K8npBSz
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256 bits))
        (Client did not present a certificate);
        Thu, 20 Aug 2020 10:49:51 +0200 (CEST)
...
Subject: [PATCH v32 01/12] Linux Random Number Generator
Date:   Thu, 20 Aug 2020 10:39:42 +0200
Message-ID: <7836955.NyiUUSuA9g@positron.chronox.de>
