...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 58E2A2C7387
	for <lists+linux-api@lfdr.de>; Sat, 28 Nov 2020 23:14:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2390360AbgK1WM7 (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Sat, 28 Nov 2020 17:12:59 -0500
Received: from youngberry.canonical.com ([91.189.89.112]:55495 "EHLO
        youngberry.canonical.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731610AbgK1WMz (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Sat, 28 Nov 2020 17:12:55 -0500
Received: from ip5f5af0a0.dynamic.kabel-deutschland.de ([95.90.240.160] helo=wittgenstein.fritz.box)
        by youngberry.canonical.com with esmtpsa (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.86_2)
        (envelope-from <christian.brauner@ubuntu.com>)
        id 1kj83P-0002aM-1b; Sat, 28 Nov 2020 21:46:52 +0000
...
Subject: [PATCH v3 29/38] fs: add helpers for idmap mounts
Date:   Sat, 28 Nov 2020 22:35:18 +0100
Message-Id: <20201128213527.2669807-30-christian.brauner@ubuntu.com>
...
---
 ...
 171 files changed, 877 insertions(+), 654 deletions(-)
...
index 7b4f154f07e6..b70d85cd70fd 100644
...
index e86d72608b9f..fb78896a1ce5 100644
--- a/fs/attr.c
+++ b/fs/attr.c
...
index bf9429484462..b89efd36ea7e 100644
--- a/fs/ext4/ext4.h
+++ b/fs/ext4/ext4.h
@@ -2846,7 +2846,7 @@ extern struct inode *__ext4_iget(struct super_block *sb, unsigned long ino,
...
index d992fef2e7c2..a1a4a00ecfa0 100644
--- a/fs/ext4/inode.c
+++ b/fs/ext4/inode.c
...
index 33509266f5a0..194bc37fba55 100644
--- a/fs/ext4/namei.c
+++ b/fs/ext4/namei.c
...
+static int ext4_symlink(struct user_namespace *user_ns, struct inode *dir,
 ...
 {
 	handle_t *handle;
@@ -4084,9 +4086,9 @@ static int ext4_cross_rename(struct inode *old_dir, struct dentry *old_dentry,
 	return retval;
 }
...
index 34f6522f5828..9c45d23caf75 100644
--- a/fs/f2fs/file.c
+++ b/fs/f2fs/file.c
...
index f1841667bcd9..034141afd9ca 100644
--- a/fs/gfs2/inode.c
+++ b/fs/gfs2/inode.c
...
@@ -1832,7 +1835,7 @@ static const char *gfs2_get_link(struct dentry *dentry,
  * Returns: errno
  */
...
@@ -1962,7 +1965,8 @@ static int setattr_chown(struct inode *inode, struct iattr *attr)
  * Returns: errno
  */
...
index 170ecc575519..4c48f1a406bf 100644
--- a/fs/nfs/dir.c
+++ b/fs/nfs/dir.c
...
+	       struct dentry *new_dentry, unsigned int flags)
 {
 	struct inode *old_inode = d_inode(old_dentry);
 	struct inode *new_inode = d_inode(new_dentry);
@@ -2740,7 +2743,7 @@ static int nfs_execute_ok(struct inode *inode, int mask)
 	return ret;
 }
...
index 1f2ab03f4903..43e08cc1c136 100644
--- a/fs/ntfs/inode.c
+++ b/fs/ntfs/inode.c
...
+ * @user_ns:	user namespace of the mount the inode is accessed from
...
+int ntfs_setattr(struct user_namespace *user_ns, struct dentry *dentry,
+		 struct iattr *attr)
 {
 	struct inode *vi = d_inode(dentry);
 	int err;
diff --git a/fs/ntfs/inode.h b/fs/ntfs/inode.h
index 363e4e820673..b1c35bfafbe3 100644
--- a/fs/ntfs/inode.h
+++ b/fs/ntfs/inode.h
...
+extern int ntfs_setattr(struct user_namespace *user_ns, struct dentry *dentry,
+			struct iattr *attr);
...
index c711d6fb3051..f65f0404517a 100644
--- a/fs/proc/base.c
+++ b/fs/proc/base.c
...
@@ -3470,7 +3471,8 @@ int proc_pid_readdir(struct file *file, struct dir_context *ctx)
...
index 5c6345c68fc5..3e889d8ace33 100644
--- a/fs/proc/generic.c
+++ b/fs/proc/generic.c
...
index c5f0db50c00f..f56c54fb0f55 100644
--- a/fs/xfs/xfs_iops.c
+++ b/fs/xfs/xfs_iops.c
...
index 78909e4071aa..c7f9ba689145 100644
--- a/include/linux/fs.h
+++ b/include/linux/fs.h
@@ -1923,21 +1923,21 @@ struct file_operations {
 struct inode_operations {
 	struct dentry * (*lookup) (struct inode *,struct dentry *, unsigned int);
...
@@ -1946,8 +1946,8 @@ struct inode_operations {
...
@@ -3208,15 +3208,17 @@ extern int dcache_dir_open(struct inode *, struct file *);
