...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1F66617AF6B
	for <lists+linux-api@lfdr.de>; Thu,  5 Mar 2020 21:11:51 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726368AbgCEULu (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Thu, 5 Mar 2020 15:11:50 -0500
Received: from hr2.samba.org ([144.76.82.148]:16974 "EHLO hr2.samba.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726251AbgCEULt (ORCPT <rfc822;linux-api@vger.kernel.org>);
        Thu, 5 Mar 2020 15:11:49 -0500
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=samba.org;
         s=42; h=Date:Message-ID:From:Cc:To;
        bh=k8VPid7ojqp6V5/9B8luooV2EhjFX2e5T50rCHeAGDg=; b=EhNzZf76h66PmMI+/Es55rA254
        
        9QuT/+lRJKPG/gFNlfKufAV4;
Received: from [127.0.0.2] (localhost [127.0.0.1])
        by hr2.samba.org with esmtpsa (TLS1.3:ECDHE_RSA_CHACHA20_POLY1305:256)
        (Exim)
        id 1j9wqL-0007Ea-NQ; Thu, 05 Mar 2020 20:11:42 +0000
To:     David Howells <dhowells@redhat.com>, linux-api@vger.kernel.org
...
Subject: Re: [RFC][PATCH] Mark AT_* path flags as deprecated and add missing
 RESOLVE_ flags
Message-ID: <4e915f46-093b-c566-1746-938dbd6dcf62@samba.org>
Date:   Thu, 5 Mar 2020 21:11:25 +0100
...
Content-Type: multipart/signed; micalg=pgp-sha512;
 ...
 boundary="MichmtXyhlSsOGP9uPfNgZULp70acC9bM"
...
--MichmtXyhlSsOGP9uPfNgZULp70acC9bM
Content-Type: multipart/mixed; boundary="bysDMfNrJXM2kt4fBGai7hHjg0HWt5oWG";
...
--bysDMfNrJXM2kt4fBGai7hHjg0HWt5oWG
...
> Do we want to do this?  Or should we duplicate the RESOLVE_* flags to A=
T_*
...
>    =20
>     It has been suggested that new path-using system calls should use R=
ESOLVE_*
>     flags instead of AT_* flags, but the RESOLVE_* flag functions are n=
ot a
>     superset of the AT_* flag functions.  So formalise this by:
>    =20
>      (1) In linux/fcntl.h, add a comment noting that the AT_* flags are=

>          deprecated for new system calls and that RESOLVE_* flags shoul=
d be
>          used instead.
>    =20
...
>      (3) Make openat2() support RESOLVE_NO_TERMINAL_SYMLINKS.  LOOKUP_O=
PEN
>          internally implies LOOKUP_AUTOMOUNT, and AT_EMPTY_PATH is prob=
ably not
...
> --- a/fs/open.c
> +++ b/fs/open.c
> @@ -977,7 +977,7 @@ inline struct open_how build_open_how(int flags, um=
ode_t mode)
>  inline int build_open_flags(const struct open_how *how, struct open_fl=
ags *op)
>  {
...
> @@ -1055,8 +1055,8 @@ inline int build_open_flags(const struct open_how=
...
> @@ -1068,6 +1068,8 @@ inline int build_open_flags(const struct open_how=
 *how, struct open_flags *op)
...

=VPIc
-----END PGP SIGNATURE-----
