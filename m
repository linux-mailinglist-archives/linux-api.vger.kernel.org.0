...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4447C1A9AA4
	for <lists+linux-api@lfdr.de>; Wed, 15 Apr 2020 12:34:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2408694AbgDOKdz (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Wed, 15 Apr 2020 06:33:55 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58498 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2408671AbgDOKcT (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Wed, 15 Apr 2020 06:32:19 -0400
Received: from mo6-p04-ob.smtp.rzone.de (mo6-p04-ob.smtp.rzone.de [IPv6:2a01:238:20a:202:5304::7])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 131DDC061A0C;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1586946735;
        ...
        bh=fLxFqNGH0u6v/DRQxKdPTRz15CmCodOvqbga82e1IgE=;
        b=
X-RZG-AUTH: ":P2ERcEykfu11Y98lp/T7+hdri+uKZK8TKWEqNyiHySGSa9k9xmwdNnzGHXPZIvSaiyU="
X-RZG-CLASS-ID: mo00
Received: from positron.chronox.de
        by smtp.strato.de (RZmta 46.4.0 DYNA|AUTH)
        with ESMTPSA id 404ef0w3FAJx12D
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256 bits))
        (Client did not present a certificate);
        Wed, 15 Apr 2020 12:19:59 +0200 (CEST)
...
Subject: [PATCH v30 01/12] Linux Random Number Generator
Date:   Wed, 15 Apr 2020 12:10:22 +0200
Message-ID: <7429357.T1bpbU5z6n@positron.chronox.de>
...
=2D--
 ...
 17 files changed, 2930 insertions(+), 1 deletion(-)
...
index ff043097ea0e..d72a13924c19 100644
=2D-- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -9794,6 +9794,13 @@ F:	Documentation/core-api/atomic_ops.rst
...
index d4665fe9ccd2..d24e4c12523e 100644
...
cha20.c
new file mode 100644
index 000000000000..e282fedda4ea
=2D-- /dev/null
