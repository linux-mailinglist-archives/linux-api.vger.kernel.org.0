...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4ADB92212A2
	for <lists+linux-api@lfdr.de>; Wed, 15 Jul 2020 18:42:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727931AbgGOQk6 (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Wed, 15 Jul 2020 12:40:58 -0400
Received: from fllv0016.ext.ti.com ([198.47.19.142]:43514 "EHLO
        fllv0016.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727106AbgGOQke (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Wed, 15 Jul 2020 12:40:34 -0400
Received: from fllv0034.itg.ti.com ([10.64.40.246])
        by fllv0016.ext.ti.com (8.15.2/8.15.2) with ESMTP id 06FGeQjq021740;
        Wed, 15 Jul 2020 11:40:26 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1594831226;
        bh=UosuttTc69A/9fAOmrG4v6EzV/WAhibpYY2w6P2pbjw=;
        h=From:To:Subject:Date:In-Reply-To:References;
        b=Pqt+gIhdEy2cxBchxUsam8dSTFZp/9y/Cp9h1SJt4+Ivl/5isowENqa6sxUSKWeVD
         0G0VPr9dTFJwYzccdtBfWP+6UepXHfWgURNWE4tXMVRas0E+Dg/2bjsNxRuBP3PC3z
         f/zt3Rz6SsDN9Hs2Gzr4gOJWXRvtl+KkuwLfh7L8=
Received: from DFLE109.ent.ti.com (dfle109.ent.ti.com [10.64.6.30])
        by fllv0034.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 06FGeQ7Y079927
        (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
        Wed, 15 Jul 2020 11:40:26 -0500
Received: from DFLE103.ent.ti.com (10.64.6.24) by DFLE109.ent.ti.com
 (10.64.6.30) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1979.3; Wed, 15
 Jul 2020 11:40:26 -0500
Received: from fllv0040.itg.ti.com (10.64.41.20) by DFLE103.ent.ti.com
 (10.64.6.24) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1979.3 via
 Frontend Transport; Wed, 15 Jul 2020 11:40:26 -0500
Received: from uda0868495.fios-router.home (ileax41-snat.itg.ti.com [10.172.224.153])
        by fllv0040.itg.ti.com (8.15.2/8.15.2) with ESMTP id 06FGeCvg081717;
...
Subject: [net-next PATCH v2 8/9] net: prp: add packet handling support
Date:   Wed, 15 Jul 2020 12:40:09 -0400
Message-ID: <20200715164012.1222-9-m-karicheri2@ti.com>
...
---
 ...
 8 files changed, 429 insertions(+), 88 deletions(-)

diff --git a/net/hsr/hsr_device.c b/net/hsr/hsr_device.c
index 07d5c2e06b49..e39c63486d1d 100644
...
index 7fc6cc7b29bb..666d1562db03 100644
...
+					       struct hsr_frame_info *frame)
 {
 	struct sk_buff *skb;
 	int copylen;
@@ -119,33 +107,113 @@ static struct sk_buff *create_stripped_skb(struct sk_buff *skb_in,
...
@@ -153,16 +221,28 @@ static void hsr_fill_tag(struct sk_buff *skb, struct hsr_frame_info *frame,
 			ETH_P_HSR : ETH_P_PRP);
 }
...
@@ -184,21 +264,29 @@ static struct sk_buff *create_tagged_skb(struct sk_buff *skb_o,
 	return skb;
 }
...
@@ -235,9 +323,18 @@ static int hsr_xmit(struct sk_buff *skb, struct hsr_port *port,
...
+ * - if it's a PRP frame: through another PRP slave device (no bridge)
  ...
  *
@@ -265,25 +362,33 @@ static void hsr_forward_do(struct hsr_frame_info *frame)
...
@@ -314,19 +419,20 @@ static void check_local_dest(struct hsr_priv *hsr, struct sk_buff *skb,
 	}
 }
...
@@ -335,29 +441,74 @@ void hsr_fill_frame_info(__be16 proto, struct sk_buff *skb,
 	}
 }
...
@@ -375,6 +526,7 @@ void hsr_forward_skb(struct sk_buff *skb, struct hsr_port *port)
...
@@ -387,6 +539,8 @@ void hsr_forward_skb(struct sk_buff *skb, struct hsr_port *port)
...
index 9717dd9404c2..8c60a7c44050 100644
