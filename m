...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B54C917DFF4
	for <lists+linux-api@lfdr.de>; Mon,  9 Mar 2020 13:19:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726633AbgCIMTV (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Mon, 9 Mar 2020 08:19:21 -0400
Received: from us-smtp-delivery-1.mimecast.com ([207.211.31.120]:31574 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726875AbgCIMTV (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Mon, 9 Mar 2020 08:19:21 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1583756358;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=+QiWu4TyoQ2gCp8zM3SS0SKNYq332gU+H4VE5c0cggA=;
        b=R9W6UT3K5bcY76b68LvzQNM1Owu2Qlbk5QJwbyo4POWEjma0vjVSvYIe3V4bK1h1I/LRzF
        YHfn34N2dNCleRiCUyjxrNTQf4OQImSSH8DhbrkMl50/EhguZRACf3Qkms24vYXN8aZnEr
        rQTGBuZCU29O941j8ZpdHkT1Flt89sE=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-407-FRf-QvZYO5yN8KNgjJSnIw-1; Mon, 09 Mar 2020 08:19:16 -0400
X-MC-Unique: FRf-QvZYO5yN8KNgjJSnIw-1
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com [10.5.11.16])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id B4F1D100550D;
        Mon,  9 Mar 2020 12:19:14 +0000 (UTC)
Received: from warthog.procyon.org.uk (ovpn-120-182.rdu2.redhat.com [10.10.120.182])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 636FC5C1C3;
        Mon,  9 Mar 2020 12:19:11 +0000 (UTC)
Organization: Red Hat UK Ltd. Registered Address: Red Hat UK Ltd, Amberley
        Place, 107-111 Peascod Street, Windsor, Berkshire, SI4 1TE, United
        Kingdom.
        Registered in England and Wales under Company Registration No. 3798903
Subject: [RFC PATCH 13/17] watch_queue: Implement mount topology and attribute
 change notifications [ver #4]
...
Date:   Mon, 09 Mar 2020 12:19:10 +0000
Message-ID: <158375635062.334846.17627430794373247997.stgit@warthog.procyon.org.uk>
...
---
 ...
 kernel/sys_ni.c                             |    3 
 27 files changed, 310 insertions(+), 3 deletions(-)
...
index 711a4093e475..381f842f3a27 100644
--- a/fs/mount.h
+++ b/fs/mount.h
@@ -4,6 +4,7 @@
...
index 000000000000..d946765afcc4
--- /dev/null
+++ b/fs/mount_notify.c
@@ -0,0 +1,186 @@
