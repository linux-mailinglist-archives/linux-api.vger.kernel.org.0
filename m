Return-Path: <linux-api+bounces-6461-lists+linux-api=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-api@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id cB1cL90jGmpU1wgAu9opvQ
	(envelope-from <linux-api+bounces-6461-lists+linux-api=lfdr.de@vger.kernel.org>)
	for <lists+linux-api@lfdr.de>; Sat, 30 May 2026 01:40:13 +0200
X-Original-To: lists+linux-api@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DA56609E37
	for <lists+linux-api@lfdr.de>; Sat, 30 May 2026 01:40:12 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id DBEFE30EDAD9
	for <lists+linux-api@lfdr.de>; Fri, 29 May 2026 23:33:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1874C3C1977;
	Fri, 29 May 2026 23:33:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="QGrgpqpO"
X-Original-To: linux-api@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-alma10-1.taild15c8.ts.net [100.103.45.18])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1ECCB3C0A12;
	Fri, 29 May 2026 23:33:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=100.103.45.18
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1780097623; cv=none; b=OmHTXAuIduW8ybozmK3pxky5dgCoXzsFbDIMYueuYbttXOuy07foKB89WckSVD9KJi1g38+p9H2eiLan6TWiQ1YvOsIewzBpInge9JTonTTAlVZm9/WOh9UvGVe6AERS5lrt7jW/kNqzWa0we5tSDDKTl4AJdjSc0qjlFtVxzxg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1780097623; c=relaxed/simple;
	bh=G2p0eZtY5HuSC3dDtVryrIKl0O5T9UpBRw40+/lIONY=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=B2pl31P//nXCC4ygzcjm3aC+GPKnPmuuH0rAf5kmV1376PEMTTsNy0LifBKTlutoBCufYuW2BwIYlmBKARwXlAjsNp/D0LQil3vf44iJm0S09vp3fWWCRfdZZ3Lw7LKfVdXsKKMbamlkl6oN7Wk5oNCV7AXZCpUEw7mRF/QNu2E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=QGrgpqpO; arc=none smtp.client-ip=100.103.45.18
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 320F51F00893;
	Fri, 29 May 2026 23:33:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kernel.org;
	s=k20260515; t=1780097620;
	bh=lLBUyfcvyVDnlD81AY82kVHbY0P4s4abERaw/Vw9AqI=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References;
	b=
...
Subject: [PATCH v4 08/11] kernel/api: add API specification for sys_write
Date: Fri, 29 May 2026 19:33:07 -0400
Message-ID: <20260529233311.1901670-9-sashal@kernel.org>
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-6461-lists,linux-api=lfdr.de];
	MIME_TRACE(0.00)[0:+];
