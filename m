...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 25C762F3E71
	for <lists+linux-api@lfdr.de>; Wed, 13 Jan 2021 01:45:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2394321AbhALWIi (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Tue, 12 Jan 2021 17:08:38 -0500
Received: from youngberry.canonical.com ([91.189.89.112]:43859 "EHLO
        youngberry.canonical.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2390983AbhALWIf (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Tue, 12 Jan 2021 17:08:35 -0500
Received: from ip5f5af0a0.dynamic.kabel-deutschland.de ([95.90.240.160] helo=wittgenstein.fritz.box)
        by youngberry.canonical.com with esmtpsa (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.86_2)
        (envelope-from <christian.brauner@ubuntu.com>)
        id 1kzRmK-0003bd-G7; Tue, 12 Jan 2021 22:04:41 +0000
...
Subject: [PATCH v5 42/42] generic/622: add fstests for idmapped mounts
Date:   Tue, 12 Jan 2021 23:01:24 +0100
Message-Id: <20210112220124.837960-43-christian.brauner@ubuntu.com>
X-Mailer: git-send-email 2.30.0
In-Reply-To: <20210112220124.837960-1-christian.brauner@ubuntu.com>
References: <20210112220124.837960-1-christian.brauner@ubuntu.com>
MIME-Version: 1.0
X-Patch-Hashes: v=1; h=sha256; i=sfpDMgrO/e+92PZxSwxxuWrtR98VRBTv+HXSZAt72dQ=; m=VAVqJmfW5vgjDtM9ed7Q7eUKrstNBYZGj+hTsVdwDRE=; p=9GhbCOveiqc2Yc0x7h1cwu2TZJudFmri1GY9rOdaC20=; g=0066cc81b46a5ba688a3270d5e609a0da8340578
X-Patch-Sig: m=pgp; i=christian.brauner@ubuntu.com; s=0x0x91C61BC06578DCA2; b=iHUEABYKAB0WIQRAhzRXHqcMeLMyaSiRxhvAZXjcogUCX/4YuQAKCRCRxhvAZXjcotOgAP4903f JEshJltiGTMk4/fjryCv7PdGhzXeJf8Jo/XAHwAD/Yqa0j4dY9rLH02eBKaMq7XACGuSVyboZSUec hJHacQU=
...
---
 ...
 src/idmapped-mounts/idmapped-mounts.c | 8001 +++++++++++++++++++++++++
 src/idmapped-mounts/missing.h         |  155 +
 src/idmapped-mounts/utils.c           |  134 +
 src/idmapped-mounts/utils.h           |   29 +
 tests/generic/622                     |   43 +
 tests/generic/622.out                 |    2 +
 tests/generic/group                   |    1 +
 15 files changed, 8473 insertions(+), 4 deletions(-)
 ...
 create mode 100755 tests/generic/622
 create mode 100644 tests/generic/622.out

diff --git a/common/rc b/common/rc
index 649b1cfd..921118fc 100644
--- a/common/rc
+++ b/common/rc
@@ -2003,6 +2003,31 @@ _require_io_uring()
 	esac
 }
...
index 811b24e4..ce281beb 100644
--- a/src/Makefile
+++ b/src/Makefile
...
index df550cf6..a654d597 100644
--- a/src/feature.c
+++ b/src/feature.c
@@ -19,6 +19,7 @@
  *
...
+ * 1. ext4
+ * - If a new directory is created within a setgid directory
+ * - always preserve the setgid bit.
+ * - If a new regular file is created within a setgid directory
+ *   - preserve the setgid bit if caller is in the group of the directory
+ *   - preserve the setgid bit if capable over the inode
+ * - If the grpid mount option is set and a new directory is created within
+ *   a setgid directory, inherit the setgid bit.
+ *
+ * 2. xfs
+ * - If a new file or directory is created within a setgid directory:
+ *   - If irix_sgid_inherit is _not_ set always inherit setgid bit (for both
+ *     regular files and directories)
+ *   - If irix_sgid_inhiert is set -> inherit the setgid bit if the caller
+ *     is in the group of the directory
+ * - If the grpid mount option is set and a new directory is created within
+ *   a setgid directory, inherit the setgid bit.
+ *
+ * In short, xfs always inherits the setgid bit for
+ * regular files and directories without the irix option whereas ext4 only
...
+status=$?
+exit
diff --git a/tests/generic/622.out b/tests/generic/622.out
new file mode 100644
index 00000000..f9793b54
--- /dev/null
+++ b/tests/generic/622.out
@@ -0,0 +1,2 @@
+QA output created by 622
+Silence is golden
diff --git a/tests/generic/group b/tests/generic/group
index 30a73605..e3b96b78 100644
...
base-commit: 2080ad637bbb4d2c24c4d63939799dab178eb407
-- 
2.30.0
