...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 2CDF31080A0
	for <lists+linux-api@lfdr.de>; Sat, 23 Nov 2019 21:42:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727156AbfKWUkT (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Sat, 23 Nov 2019 15:40:19 -0500
Received: from mo4-p04-ob.smtp.rzone.de ([85.215.255.120]:13644 "EHLO
        mo4-p04-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727295AbfKWUkP (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Sat, 23 Nov 2019 15:40:15 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1574541605;
        s=strato-dkim-0002; d=chronox.de;
        h=References:In-Reply-To:Message-ID:Date:Subject:Cc:To:From:
        X-RZG-CLASS-ID:X-RZG-AUTH:From:Subject:Sender;
        bh=90VpmiCr0MHkiXu9AIogy/D9G9CdJfnZ45lJ6kI9whc=;
        b=
X-RZG-AUTH: ":P2ERcEykfu11Y98lp/T7+hdri+uKZK8TKWEqNyiHySGSa9k9xmwdNnzHHXDaJfSfWrhX"
X-RZG-CLASS-ID: mo00
Received: from positron.chronox.de
        by smtp.strato.de (RZmta 44.29.0 DYNA|AUTH)
        with ESMTPSA id N09a57vANKcf3yb
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (curve secp521r1 with 521 ECDH bits, eq. 15360 bits RSA))
        (Client did not present a certificate);
        Sat, 23 Nov 2019 21:38:41 +0100 (CET)
...
Date:   Sat, 23 Nov 2019 21:10:16 +0100
Message-ID: <4092523.WvKr7FP7fE@positron.chronox.de>
...
+
+	while (1) {
+		ssize_t n =3D lrng_read_common(buf, nbytes, lrng_read_random);
+
+		if (n)
+			return n;
+
...
+ * GRND_TRUERANDOM called with CAP_SYS_ADMIN while /dev/urandom is stresse=
d.
+ *
+ * This value is allowed to be changed.
+ */
...
+
+/*
+ * Leave given amount of entropy in bits in entropy to serve GRND_TRUERAND=
OM
+ * called without CAP_SYS_ADMIN. Providing TRNG data to unprivileged users
+ * should have the least priority and should not affect other users of ent=
ropy.
+ */
...
+	int ret =3D lrng_trng_seed(seedbuf, sizeof(seedbuf),
