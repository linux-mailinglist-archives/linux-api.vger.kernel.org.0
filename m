...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 7F3451641F6
	for <lists+linux-api@lfdr.de>; Wed, 19 Feb 2020 11:24:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726718AbgBSKYF (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Wed, 19 Feb 2020 05:24:05 -0500
Received: from hr2.samba.org ([144.76.82.148]:33426 "EHLO hr2.samba.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726617AbgBSKYE (ORCPT <rfc822;linux-api@vger.kernel.org>);
        Wed, 19 Feb 2020 05:24:04 -0500
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=samba.org;
         s=42; h=Date:Message-ID:From:Cc:To;
        bh=me73llNaSNm+iSzuirXxEqSiFD0Dih3wdaRg2EZTfXg=; b=LE5iRQ0MOTn/BDSZcA8z33R0ln
        
        wl4hQKOElsrSe2KCmq0WEWDz;
Received: from [127.0.0.2] (localhost [127.0.0.1])
        by hr2.samba.org with esmtpsa (TLS1.3:ECDHE_RSA_CHACHA20_POLY1305:256)
        (Exim)
        id 1j4MWM-0008Su-Ig; Wed, 19 Feb 2020 10:23:58 +0000
...
Content-Type: multipart/signed; micalg=pgp-sha512;
 ...
 boundary="VUoKbHKI4gvmv7Y9GPUVwygSmdGQV2Gtb"
...
--VUoKbHKI4gvmv7Y9GPUVwygSmdGQV2Gtb
Content-Type: multipart/mixed; boundary="ZS7rK2aKPYyYCtkmYFsUANtAg8qz28mNh";
...
--ZS7rK2aKPYyYCtkmYFsUANtAg8qz28mNh
...
>  (3) New single-bit capability flags can be added.  This is a structure=
-typed
>      attribute and, as such, (2) applies.  Any bits you wanted but the =
kernel
...
> mount topology specified by the dirfd, path and at_flags parameters.  A=
ll
> mount topology change and mount attribute change notifications in the
> subtree rooted at that point can be intercepted by the watch.  Watches =
are
...

=mgOG
-----END PGP SIGNATURE-----
