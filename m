...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E7C4217EA8E
	for <lists+linux-api@lfdr.de>; Mon,  9 Mar 2020 21:56:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726169AbgCIU4d (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Mon, 9 Mar 2020 16:56:33 -0400
Received: from hr2.samba.org ([144.76.82.148]:23594 "EHLO hr2.samba.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726096AbgCIU4c (ORCPT <rfc822;linux-api@vger.kernel.org>);
        Mon, 9 Mar 2020 16:56:32 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=samba.org;
         s=42; h=Date:Message-ID:From:Cc:To;
        bh=gdBZIArOteFOAINtVgd3WoevhioAU/9HVA+FwWoFw0Q=; b=2vrgQdiUzOPCEteu/38VIz9XMi
        
        jxNxv+D1YvUdx2fH2JZ3a4Sl;
Received: from [127.0.0.2] (localhost [127.0.0.1])
        by hr2.samba.org with esmtpsa (TLS1.3:ECDHE_RSA_CHACHA20_POLY1305:256)
        (Exim)
        id 1jBPRp-0000NP-7K; Mon, 09 Mar 2020 20:56:25 +0000
To:     David Howells <dhowells@redhat.com>, torvalds@linux-foundation.org,
        viro@zeniv.linux.org.uk
Cc:     Aleksa Sarai <cyphar@cyphar.com>, raven@themaw.net,
...
Content-Type: multipart/signed; micalg=pgp-sha512;
 ...
 boundary="zkTWQkqGc5uf17xE3z75RnSIzZfruno2Y"
...
--zkTWQkqGc5uf17xE3z75RnSIzZfruno2Y
Content-Type: multipart/mixed; boundary="Lfh9VrLHsjqxyxHJwW0wQ5OS3rYZUToVX";
 protected-headers="v1"
From: Stefan Metzmacher <metze@samba.org>
To: David Howells <dhowells@redhat.com>, torvalds@linux-foundation.org,
 viro@zeniv.linux.org.uk
Cc: Aleksa Sarai <cyphar@cyphar.com>, raven@themaw.net, mszeredi@redhat.com,
...
--Lfh9VrLHsjqxyxHJwW0wQ5OS3rYZUToVX
...
> This is necessary for fsinfo() to use RESOLVE_* flags instead of AT_* f=
lags
> if the latter are to be considered deprecated for new system calls.
>=20
> Also make openat2() handle RESOLVE_NO_TRAILING_SYMLINKS.
>=20
> Automounting is currently forced by doing an open(), so adding support =
to
> openat2() for RESOLVE_NO_TRAILING_AUTOMOUNTS is not trivial.

lookup_flags &=3D ~LOOKUP_AUTOMOUNT won't work?
...

=vpWU
-----END PGP SIGNATURE-----
