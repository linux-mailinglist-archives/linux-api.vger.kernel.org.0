...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CC6B117E002
	for <lists+linux-api@lfdr.de>; Mon,  9 Mar 2020 13:19:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726704AbgCIMTr (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Mon, 9 Mar 2020 08:19:47 -0400
Received: from us-smtp-1.mimecast.com ([207.211.31.81]:30697 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726715AbgCIMTr (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Mon, 9 Mar 2020 08:19:47 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1583756385;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=AGBnv2c2JrP/iDUmD1EOILErQlUMOvVdoNe1covg4Ss=;
        b=PqDQ/Dmczy7LLVwXbv2n/M1fMVHQxybdxf6LLNEIf9f/gauK+9IPDoNYwueCkDM5mgLAmd
        IX4CHqJ0MovWP5eiYC7KRIsG2lp6mThvxMhdNDPsMvyganYrctN7bwvCAJMjaoBkryL7W7
        zeeHCtGEy6Jyh83WCZjeW56LhlLTTEU=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-381-TuCS_kYLPo6YPgJkjqhjWQ-1; Mon, 09 Mar 2020 08:19:42 -0400
X-MC-Unique: TuCS_kYLPo6YPgJkjqhjWQ-1
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id CE3298010F5;
        Mon,  9 Mar 2020 12:19:40 +0000 (UTC)
Received: from warthog.procyon.org.uk (ovpn-120-182.rdu2.redhat.com [10.10.120.182])
        by smtp.corp.redhat.com (Postfix) with ESMTP id DB9CA60BFB;
        Mon,  9 Mar 2020 12:19:37 +0000 (UTC)
Organization: Red Hat UK Ltd. Registered Address: Red Hat UK Ltd, Amberley
        Place, 107-111 Peascod Street, Windsor, Berkshire, SI4 1TE, United
        Kingdom.
        Registered in England and Wales under Company Registration No. 3798903
Subject: [RFC PATCH 16/17] watch_queue: Add superblock notifications [ver #4]
...
Date:   Mon, 09 Mar 2020 12:19:37 +0000
Message-ID: <158375637720.334846.6091993686806244308.stgit@warthog.procyon.org.uk>
...
---
 ...
 kernel/sys_ni.c                             |    3 +
 24 files changed, 280 insertions(+), 3 deletions(-)
...
index ececa5695fd1..a7aa16ca380c 100644
--- a/fs/super.c
+++ b/fs/super.c
@@ -37,6 +37,8 @@
...
@@ -1891,3 +1899,127 @@ void vfs_generate_unique_id(u64 *_id)
...
index 9de6bfe41016..9181cfcd5265 100644
...
@@ -3654,4 +3661,78 @@ static inline int inode_drain_writes(struct inode *inode)
