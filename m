...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9F4451EAFC8
	for <lists+linux-api@lfdr.de>; Mon,  1 Jun 2020 21:48:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727099AbgFATsi (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Mon, 1 Jun 2020 15:48:38 -0400
Received: from hqnvemgate24.nvidia.com ([216.228.121.143]:9769 "EHLO
        hqnvemgate24.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727096AbgFATsi (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Mon, 1 Jun 2020 15:48:38 -0400
Received: from hqpgpgate101.nvidia.com (Not Verified[216.228.121.13]) by hqnvemgate24.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5ed55b360000>; Mon, 01 Jun 2020 12:47:02 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate101.nvidia.com (PGP Universal service);
  Mon, 01 Jun 2020 12:48:37 -0700
X-PGP-Universal: processed;
        by hqpgpgate101.nvidia.com on Mon, 01 Jun 2020 12:48:37 -0700
Received: from HQMAIL101.nvidia.com (172.20.187.10) by HQMAIL107.nvidia.com
 (172.20.187.13) with Microsoft SMTP Server (TLS) id 15.0.1473.3; Mon, 1 Jun
 2020 19:48:37 +0000
Received: from rnnvemgw01.nvidia.com (10.128.109.123) by HQMAIL101.nvidia.com
 (172.20.187.10) with Microsoft SMTP Server (TLS) id 15.0.1473.3 via Frontend
 Transport; Mon, 1 Jun 2020 19:48:36 +0000
Received: from ng-desktop.nvidia.com (Not Verified[10.110.48.88]) by rnnvemgw01.nvidia.com with Trustwave SEG (v7,5,8,10121)
        id <B5ed55b930003>; Mon, 01 Jun 2020 12:48:36 -0700
...
Subject: [PATCH v6] mm: Proactive compaction
Date:   Mon, 1 Jun 2020 12:48:22 -0700
Message-ID: <20200601194822.30252-1-nigupta@nvidia.com>
X-Mailer: git-send-email 2.26.2
MIME-Version: 1.0
Content-Type: text/plain; charset="UTF-8"
Content-Transfer-Encoding: quoted-printable
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1591040822; bh=PS3592/V6A2xPjuNJQANjrVCzn9TTWqImpa3Ko4zVbU=;
        h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
         MIME-Version:Content-Type:Content-Transfer-Encoding;
        b=
...
+
 ...
 {
 	unsigned int order;
@@ -1881,6 +1969,25 @@ static enum compact_result __compact_finished(struct=
 compact_control *cc)
...
=20
@@ -1939,6 +2046,7 @@ static enum compact_result __compact_finished(struct =
compact_control *cc)
 		}
 	}
=20
...
=20
@@ -2412,6 +2520,41 @@ enum compact_result try_to_compact_pages(gfp_t gfp_m=
