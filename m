...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0F21F2DFE5E
	for <lists+linux-api@lfdr.de>; Mon, 21 Dec 2020 17:58:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726057AbgLUQ6d (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Mon, 21 Dec 2020 11:58:33 -0500
Received: from us-smtp-delivery-124.mimecast.com ([63.128.21.124]:27524 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726027AbgLUQ6d (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Mon, 21 Dec 2020 11:58:33 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1608569825;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:in-reply-to:in-reply-to:references:references;
        bh=2/LTbTxxdt8HYjSO3udRLh8bdn+S1dvla4qtkq9Nr/U=;
        b=MXSPjugF//lTVxwGjYEMnsO2HLZMux/lVwMzSZpGvqTbSyZkuxNjN7bc8SWW5hnJCltPHb
        hPAsOzovURk8IbmzBGUwG+8osNdgAx4PqHihxMUSlYYulHgo5H75yHj+CAC7ZGbwcQtSe/
        UJvNErJbGVaWGJW4FnN9AMH5DigezSc=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-104-eUon2VENOSOg1g380oms6w-1; Mon, 21 Dec 2020 11:57:03 -0500
X-MC-Unique: eUon2VENOSOg1g380oms6w-1
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 9ED6F801AA3;
        Mon, 21 Dec 2020 16:57:00 +0000 (UTC)
Received: from madcap2.tricolour.ca (unknown [10.10.110.9])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 99C3160C0F;
        Mon, 21 Dec 2020 16:56:44 +0000 (UTC)
...
Subject: [PATCH ghak90 v10 02/11] audit: add container id
Date:   Mon, 21 Dec 2020 11:55:36 -0500
Message-Id: <a7d9885ece18f8c4c54f7d9502f108f397b28b39.1608225886.git.rgb@redhat.com>
...
--- a/fs/proc/base.c
+++ b/fs/proc/base.c
@@ -1242,7 +1242,7 @@ static const struct file_operations proc_oom_score_adj_operations = {
 };
...
+#define TMPBUFLEN 21
 ...
 {
@@ -1329,6 +1329,58 @@ static const struct file_operations proc_sessionid_operations = {
...
@@ -3231,6 +3283,7 @@ static const struct pid_entry tgid_base_stuff[] = {
 #ifdef CONFIG_AUDIT
...
@@ -3570,6 +3623,7 @@ static const struct pid_entry tid_base_stuff[] = {
 #ifdef CONFIG_AUDIT
 	REG("loginuid",  S_IWUSR|S_IRUGO, proc_loginuid_operations),
 	REG("sessionid",  S_IRUGO, proc_sessionid_operations),
+	REG("audit_containerid", S_IWUSR|S_IRUSR, proc_contid_operations),
...
index 2719ca147150..a5f7d1d6945e 100644
--- a/kernel/audit.c
+++ b/kernel/audit.c
...
index dc8dc103a8a4..928dce5bb88e 100644
--- a/kernel/auditsc.c
+++ b/kernel/auditsc.c
