...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0D6C31943AB
	for <lists+linux-api@lfdr.de>; Thu, 26 Mar 2020 16:57:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727907AbgCZP5K (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Thu, 26 Mar 2020 11:57:10 -0400
Received: from mail.efficios.com ([167.114.26.124]:47384 "EHLO
        mail.efficios.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727717AbgCZP5J (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Thu, 26 Mar 2020 11:57:09 -0400
Received: from localhost (localhost [127.0.0.1])
        by mail.efficios.com (Postfix) with ESMTP id 45532277D41;
        Thu, 26 Mar 2020 11:57:05 -0400 (EDT)
Received: from mail.efficios.com ([127.0.0.1])
        by localhost (mail03.efficios.com [127.0.0.1]) (amavisd-new, port 10032)
        with ESMTP id swDP4Ktk9UrQ; Thu, 26 Mar 2020 11:57:02 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
        by mail.efficios.com (Postfix) with ESMTP id 54553277EB6;
        Thu, 26 Mar 2020 11:57:00 -0400 (EDT)
DKIM-Filter: OpenDKIM Filter v2.10.3 mail.efficios.com 54553277EB6
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=efficios.com;
        s=default; t=1585238220;
        bh=jdHcOeQd14kvTLzyGRIb/QBbhHQ4Vbipdt2U/gehKQ0=;
        h=From:To:Date:Message-Id;
        b=
X-Virus-Scanned: amavisd-new at efficios.com
Received: from mail.efficios.com ([127.0.0.1])
        by localhost (mail03.efficios.com [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id kuaCJhV4wWNj; Thu, 26 Mar 2020 11:57:00 -0400 (EDT)
Received: from localhost.localdomain (192-222-181-218.qc.cable.ebox.net [192.222.181.218])
        by mail.efficios.com (Postfix) with ESMTPSA id A2C2C277F07;
        Thu, 26 Mar 2020 11:56:57 -0400 (EDT)
...
Subject: [PATCH glibc 5/9] glibc: Perform rseq(2) registration at C startup and thread creation (v17)
Date:   Thu, 26 Mar 2020 11:56:29 -0400
