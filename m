Return-Path: <linux-api+bounces-6720-lists+linux-api=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-api@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id AulUCV4aQmoT0QkAu9opvQ
	(envelope-from <linux-api+bounces-6720-lists+linux-api=lfdr.de@vger.kernel.org>)
	for <lists+linux-api@lfdr.de>; Mon, 29 Jun 2026 09:10:22 +0200
X-Original-To: lists+linux-api@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 864BC6D6CBF
	for <lists+linux-api@lfdr.de>; Mon, 29 Jun 2026 09:10:21 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=messagingengine.com header.s=fm1 header.b=HvjgLc9t;
	spf=pass (mail.lfdr.de: domain of "linux-api+bounces-6720-lists+linux-api=lfdr.de@vger.kernel.org" designates 172.105.105.114 as permitted sender) smtp.mailfrom="linux-api+bounces-6720-lists+linux-api=lfdr.de@vger.kernel.org";
...
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id ED58C302813C
	for <lists+linux-api@lfdr.de>; Mon, 29 Jun 2026 07:00:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C1C003B4439;
...
X-Spamd-Result: default: False [1.44 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TO_DN_ALL(0.00)[];
	TAGGED_FROM(0.00)[bounces-6720-lists,linux-api=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[messagingengine.com:dkim,tor.lore.kernel.org:rdns,tor.lore.kernel.org:helo,vger.kernel.org:from_smtp,johnericson.me:email,Obsidian.Systems:mid,Obsidian.Systems:from_mime]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: 864BC6D6CBF
