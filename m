...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1A409653265
	for <lists+linux-api@lfdr.de>; Wed, 21 Dec 2022 15:24:18 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234435AbiLUOYP (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Wed, 21 Dec 2022 09:24:15 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58388 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234094AbiLUOYA (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Wed, 21 Dec 2022 09:24:00 -0500
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D0BF623BC4;
        Wed, 21 Dec 2022 06:23:52 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 6A491B81B9A;
        Wed, 21 Dec 2022 14:23:51 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id ACC3EC433D2;
        Wed, 21 Dec 2022 14:23:48 +0000 (UTC)
Authentication-Results: smtp.kernel.org;
        dkim=pass (1024-bit key) header.d=zx2c4.com header.i=@zx2c4.com header.b="Xxu/rfPc"
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=zx2c4.com; s=20210105;
        ...
        bh=EPbPp9pVXfRIMWZXHVXc8hFjwDXo0mRk/v2R9kWPrps=;
        b=Xxu/rfPc2TkClk7VMRECuFIDnfzQuF4IfmPbQeAal5dzL+jOc3uwqmmBinbP1xtts1lupv
        b5Nx1ouEdJvATdaTWWrBkP6PQBxi9paQq79HuweLOF+vqcerJHk7N4D3kLPJZxoP0WPplu
        djDYawMDDoGcgzVh8vBnWNjfi5T/gGU=
Received: by mail.zx2c4.com (ZX2C4 Mail Server) with ESMTPSA id 6b20001a (TLSv1.3:TLS_AES_256_GCM_SHA384:256:NO);
...
Subject: [PATCH v13 4/7] random: add vgetrandom_alloc() syscall
Date:   Wed, 21 Dec 2022 15:23:24 +0100
Message-Id: <20221221142327.126451-5-Jason@zx2c4.com>
...
index 5490b1f94803..1984d383aebf 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -17517,6 +17517,7 @@ T:	git https://git.kernel.org/pub/scm/linux/kernel/git/crng/random.git
 S:	Maintained
