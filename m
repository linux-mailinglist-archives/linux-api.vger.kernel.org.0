...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9CCC52A3B51
	for <lists+linux-api@lfdr.de>; Tue,  3 Nov 2020 05:10:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726140AbgKCEKV (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Mon, 2 Nov 2020 23:10:21 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35664 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725940AbgKCEKU (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Mon, 2 Nov 2020 23:10:20 -0500
Received: from mail-pl1-x64a.google.com (mail-pl1-x64a.google.com [IPv6:2607:f8b0:4864:20::64a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7D345C0617A6
        for <linux-api@vger.kernel.org>; Mon,  2 Nov 2020 20:10:19 -0800 (PST)
Received: by mail-pl1-x64a.google.com with SMTP id c4so9917801pll.20
        for <linux-api@vger.kernel.org>; Mon, 02 Nov 2020 20:10:19 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20161025;
        h=sender:date:in-reply-to:message-id:mime-version:references:subject
         :from:to:cc;
        bh=PRYkiUn0AltiqwfWkoHX74GUbTNu6lkULHAnJbppj88=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=PRYkiUn0AltiqwfWkoHX74GUbTNu6lkULHAnJbppj88=;
        b=
X-Gm-Message-State: AOAM5312qfwEZtMwczuoavsIve0KVx3/fTsmsEyvEo60ak+gBQ6p1Nde
        owb4anuBwWzny7a560acr92tIUM=
X-Google-Smtp-Source: ABdhPJw5hbaZ6F499kX6Xz2K/No0NSbL6+0aJKGBO4e2i83/VZVoV0cIpFuW06IMDkW8StIYfkkmFXc=
Sender: "pcc via sendgmr" <pcc@pcc-desktop.svl.corp.google.com>
X-Received: from pcc-desktop.svl.corp.google.com ([2620:15c:2ce:0:7220:84ff:fe09:385a])
 (user=pcc job=sendgmr) by 2002:a17:90a:3fcb:: with SMTP id
 u11mr1689492pjm.128.1604376619007; Mon, 02 Nov 2020 20:10:19 -0800 (PST)
Date:   Mon,  2 Nov 2020 20:09:44 -0800
In-Reply-To: <cover.1604376407.git.pcc@google.com>
Message-Id: <c8a229473591a7bf98dc79e92403fe2de854ffef.1604376407.git.pcc@google.com>
Mime-Version: 1.0
References: <cover.1604376407.git.pcc@google.com>
X-Mailer: git-send-email 2.29.1.341.ge80a0c044ae-goog
Subject: [PATCH v13 8/8] arm64: expose FAR_EL1 tag bits in siginfo
