...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0BF872F3E26
	for <lists+linux-api@lfdr.de>; Wed, 13 Jan 2021 01:45:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2394246AbhALWGC (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Tue, 12 Jan 2021 17:06:02 -0500
Received: from youngberry.canonical.com ([91.189.89.112]:43128 "EHLO
        youngberry.canonical.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2387454AbhALWEM (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Tue, 12 Jan 2021 17:04:12 -0500
Received: from ip5f5af0a0.dynamic.kabel-deutschland.de ([95.90.240.160] helo=wittgenstein.fritz.box)
        by youngberry.canonical.com with esmtpsa (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.86_2)
        (envelope-from <christian.brauner@ubuntu.com>)
        id 1kzRkz-0003bd-NV; Tue, 12 Jan 2021 22:03:17 +0000
...
Subject: [PATCH v5 13/42] attr: handle idmapped mounts
Date:   Tue, 12 Jan 2021 23:00:55 +0100
Message-Id: <20210112220124.837960-14-christian.brauner@ubuntu.com>
X-Mailer: git-send-email 2.30.0
In-Reply-To: <20210112220124.837960-1-christian.brauner@ubuntu.com>
References: <20210112220124.837960-1-christian.brauner@ubuntu.com>
MIME-Version: 1.0
X-Patch-Hashes: v=1; h=sha256; i=ySHp/IRsSCZ22uUIZ1JWat8MdiucaagH+6NnvXYTxI4=; m=9oB9m6TAM5MtMvwQmZT2szjMb3MUUBdWnGraMgmu0UA=; p=G894PxyQhyVkL+RV/EntbRjD6vesE/nQiBz/GkDew7I=; g=158b7241cf05ef3b45556665ce42ebceb6b50c5b
X-Patch-Sig: m=pgp; i=christian.brauner@ubuntu.com; s=0x0x91C61BC06578DCA2; b=iHUEABYKAB0WIQRAhzRXHqcMeLMyaSiRxhvAZXjcogUCX/4YtgAKCRCRxhvAZXjcou3yAQDYaRj i809jCiB7DL+jO04msS0/2fAxQVaAQzw3ea5DqwEAkJ4Dhy5xhN8TosTBaxQh2SF8ddssUrB0g/uA 2qBhaQw=
...
index 550f89553b80..19d432a453b1 100644
--- a/fs/btrfs/inode.c
+++ b/fs/btrfs/inode.c
...
index 27946882d4ce..644510b5e06c 100644
--- a/fs/ext4/inode.c
+++ b/fs/ext4/inode.c
@@ -5333,7 +5333,7 @@ int ext4_setattr(struct dentry *dentry, struct iattr *attr)
...
@@ -5508,7 +5508,7 @@ int ext4_setattr(struct dentry *dentry, struct iattr *attr)
 	}
...
index 19a46f445d4c..eb648ed19312 100644
--- a/fs/fuse/dir.c
+++ b/fs/fuse/dir.c
@@ -1610,7 +1610,7 @@ int fuse_do_setattr(struct dentry *dentry, struct iattr *attr,
...
index b3ccb2997ea0..5db88d703b63 100644
--- a/fs/nfsd/vfs.c
+++ b/fs/nfsd/vfs.c
...
index 4089ed2c51ec..bae00ee63af8 100644
--- a/fs/open.c
+++ b/fs/open.c
...
index 430434317f9e..ef993857682b 100644
