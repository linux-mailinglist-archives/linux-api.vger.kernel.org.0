...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EE77224CDA5
	for <lists+linux-api@lfdr.de>; Fri, 21 Aug 2020 08:03:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728000AbgHUGDW (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Fri, 21 Aug 2020 02:03:22 -0400
Received: from mo4-p04-ob.smtp.rzone.de ([85.215.255.122]:27503 "EHLO
        mo4-p04-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727822AbgHUGDT (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Fri, 21 Aug 2020 02:03:19 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1597989764;
        s=strato-dkim-0002; d=chronox.de;
        h=References:In-Reply-To:Message-ID:Date:Subject:Cc:To:From:
        X-RZG-CLASS-ID:X-RZG-AUTH:From:Subject:Sender;
        bh=nY4BxNQOFda9XwFeVTl1N0PjBehJP85AOcrN7aq3NG4=;
        b=
X-RZG-AUTH: ":P2ERcEykfu11Y98lp/T7+hdri+uKZK8TKWEqNyiHySGSa9k9xm0dNS3IdRAZAL+p6A=="
X-RZG-CLASS-ID: mo00
Received: from positron.chronox.de
        by smtp.strato.de (RZmta 46.10.7 DYNA|AUTH)
        with ESMTPSA id 002e9aw7L61IGLF
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256 bits))
        (Client did not present a certificate);
        Fri, 21 Aug 2020 08:01:18 +0200 (CEST)
...
Subject: [PATCH v33 01/12] Linux Random Number Generator
Date:   Fri, 21 Aug 2020 07:38:37 +0200
Message-ID: <7836152.NyiUUSuA9g@positron.chronox.de>
