...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9F4571C0C05
	for <lists+linux-api@lfdr.de>; Fri,  1 May 2020 04:15:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728092AbgEACO6 (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Thu, 30 Apr 2020 22:14:58 -0400
Received: from mail.efficios.com ([167.114.26.124]:37604 "EHLO
        mail.efficios.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728029AbgEACO6 (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Thu, 30 Apr 2020 22:14:58 -0400
Received: from localhost (localhost [127.0.0.1])
        by mail.efficios.com (Postfix) with ESMTP id 886DD294169;
        Thu, 30 Apr 2020 22:14:53 -0400 (EDT)
Received: from mail.efficios.com ([127.0.0.1])
        by localhost (mail03.efficios.com [127.0.0.1]) (amavisd-new, port 10032)
        with ESMTP id T4VqZuaV5yse; Thu, 30 Apr 2020 22:14:51 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
        by mail.efficios.com (Postfix) with ESMTP id 0473B294167;
        Thu, 30 Apr 2020 22:14:51 -0400 (EDT)
DKIM-Filter: OpenDKIM Filter v2.10.3 mail.efficios.com 0473B294167
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=efficios.com;
        s=default; t=1588299291;
        bh=FfnSm1pB/iaxPHSnb3Cmd4VzeUNUS7uZHyCRHmtCRFY=;
        h=From:To:Date:Message-Id;
        b=
X-Virus-Scanned: amavisd-new at efficios.com
Received: from mail.efficios.com ([127.0.0.1])
        by localhost (mail03.efficios.com [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id VmtgH0A3u4vZ; Thu, 30 Apr 2020 22:14:50 -0400 (EDT)
Received: from localhost.localdomain (192-222-181-218.qc.cable.ebox.net [192.222.181.218])
        by mail.efficios.com (Postfix) with ESMTPSA id 986C229433D;
...
Subject: [PATCH glibc 1/3] glibc: Perform rseq registration at C startup and thread creation (v19)
Date:   Thu, 30 Apr 2020 22:14:37 -0400
Message-Id: <20200501021439.2456-2-mathieu.desnoyers@efficios.com>
