...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 73F0B1AF33A
	for <lists+linux-api@lfdr.de>; Sat, 18 Apr 2020 20:36:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726842AbgDRSgi (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Sat, 18 Apr 2020 14:36:38 -0400
Received: from hr2.samba.org ([144.76.82.148]:52880 "EHLO hr2.samba.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725824AbgDRSgd (ORCPT <rfc822;linux-api@vger.kernel.org>);
        Sat, 18 Apr 2020 14:36:33 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=samba.org;
         s=42; h=Date:Message-ID:From:Cc:To;
        bh=B2omtd62e5YQj7tPTVCCsxqUChL8VWhx0Z0LQTIjznM=; b=fMrFF8WnUyAllJXqqUzjGPstTO
        
        NDgm6fo5U9DrOHhw5jH3byI8;
Received: from [127.0.0.2] (localhost [127.0.0.1])
        by hr2.samba.org with esmtpsa (TLS1.3:ECDHE_RSA_CHACHA20_POLY1305:256)
        (Exim)
        id 1jPsKG-0007Gv-I3; Sat, 18 Apr 2020 18:36:24 +0000
...
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.7.0
MIME-Version: 1.0
In-Reply-To: <20200416143532.11743-1-mszeredi@redhat.com>
Content-Type: multipart/signed; micalg=pgp-sha512;
 protocol="application/pgp-signature";
 boundary="fPRHY2yPCSeROKb0k5q1BDtcQNA93xNgz"
...
--fPRHY2yPCSeROKb0k5q1BDtcQNA93xNgz
Content-Type: multipart/mixed; boundary="3v2qLvF6bSvEFb9crNnM81yM9XM15dvcc";
...
--3v2qLvF6bSvEFb9crNnM81yM9XM15dvcc
...
> POSIX defines faccessat() as having a fourth "flags" argument, while th=
e
...
> AT_REMOVEDIR.  Use this value for the kernel interface as well, togethe=
r
...

=c7wh
-----END PGP SIGNATURE-----
