...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id AAC0D182BE7
	for <lists+linux-api@lfdr.de>; Thu, 12 Mar 2020 10:08:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726569AbgCLJIV (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Thu, 12 Mar 2020 05:08:21 -0400
Received: from hr2.samba.org ([144.76.82.148]:25820 "EHLO hr2.samba.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726000AbgCLJIT (ORCPT <rfc822;linux-api@vger.kernel.org>);
        Thu, 12 Mar 2020 05:08:19 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=samba.org;
         s=42; h=Date:Message-ID:From:Cc:To;
        bh=WHv2oZcHAyJfBbA1rplG2X6faOpWM/yra+mGY5E5v4U=; b=QhtZCAo/bOTdk5RPBPpKPpwduP
        
        BjJKRczY2cIwvdkAcqYrI0Bg;
Received: from [127.0.0.2] (localhost [127.0.0.1])
        by hr2.samba.org with esmtpsa (TLS1.3:ECDHE_RSA_CHACHA20_POLY1305:256)
        (Exim)
        id 1jCJp6-0004Gp-JZ; Thu, 12 Mar 2020 09:08:12 +0000
...
Content-Type: multipart/signed; micalg=pgp-sha512;
 ...
 boundary="h9vER1n2IibBVz13qkLQwS7lTwf1qhdtl"
...
--h9vER1n2IibBVz13qkLQwS7lTwf1qhdtl
Content-Type: multipart/mixed; boundary="sTfSkVUqh6p1IQLMoxEfSKhj4lw7USbt6";
...
--sTfSkVUqh6p1IQLMoxEfSKhj4lw7USbt6
...
>> Okay.  So what's the equivalent of AT_SYMLINK_NOFOLLOW in RESOLVE_* fl=
ag
>> terms?
>=20
> Nothing.
...

=qkj1
-----END PGP SIGNATURE-----
