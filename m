...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8E5E92B6F5D
	for <lists+linux-api@lfdr.de>; Tue, 17 Nov 2020 20:53:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731355AbgKQTwT (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Tue, 17 Nov 2020 14:52:19 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35600 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730439AbgKQTwR (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Tue, 17 Nov 2020 14:52:17 -0500
Received: from mail-qt1-x84a.google.com (mail-qt1-x84a.google.com [IPv6:2607:f8b0:4864:20::84a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5AC1CC0613CF
        for <linux-api@vger.kernel.org>; Tue, 17 Nov 2020 11:52:17 -0800 (PST)
Received: by mail-qt1-x84a.google.com with SMTP id e22so13186106qte.22
        for <linux-api@vger.kernel.org>; Tue, 17 Nov 2020 11:52:17 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20161025;
        h=sender:date:message-id:mime-version:subject:from:to:cc;
        bh=G8OHtIh4Nrss2knjnwbCatND2+0dN1N5IDlWgO9j+NI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:sender:date:message-id:mime-version:subject:from
         :to:cc;
        bh=G8OHtIh4Nrss2knjnwbCatND2+0dN1N5IDlWgO9j+NI=;
        b=
X-Gm-Message-State: AOAM532VzDXg39wb3RLvOGVsBaWOlD60Kqw9A4AcqkbZ+DvC1WfEZvKt
        fn/X/cgbrWROunINbaC9oY1RdZQ=
X-Google-Smtp-Source: ABdhPJwtR0mplSI9nYTqjKsrjhZN830Vb5WTAaVC7NfeUXJ1TBNxNNTnTekaxfuc6HJ9V0BwUZ8eAns=
Sender: "pcc via sendgmr" <pcc@pcc-desktop.svl.corp.google.com>
X-Received: from pcc-desktop.svl.corp.google.com ([2620:15c:2ce:0:7220:84ff:fe09:385a])
 (user=pcc job=sendgmr) by 2002:a0c:b207:: with SMTP id x7mr1271797qvd.39.1605642736471;
 Tue, 17 Nov 2020 11:52:16 -0800 (PST)
Date:   Tue, 17 Nov 2020 11:52:05 -0800
Message-Id: <20201117195205.645925-1-pcc@google.com>
Mime-Version: 1.0
X-Mailer: git-send-email 2.29.2.299.gdc1121823c-goog
Subject: [PATCH v18] arm64: expose FAR_EL1 tag bits in siginfo
...
- rename set_thread_esr to set_thread_far_esr
 ...
 kernel/signal.c                         | 20 ++++++++
 15 files changed, 145 insertions(+), 70 deletions(-)
