Return-Path: <linux-api+bounces-6097-lists+linux-api=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-api@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id KBdOHb3e4GkEnAAAu9opvQ
	(envelope-from <linux-api+bounces-6097-lists+linux-api=lfdr.de@vger.kernel.org>)
	for <lists+linux-api@lfdr.de>; Thu, 16 Apr 2026 15:06:05 +0200
X-Original-To: lists+linux-api@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [104.64.211.4])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D81140E747
	for <lists+linux-api@lfdr.de>; Thu, 16 Apr 2026 15:06:04 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 47575300D573
	for <lists+linux-api@lfdr.de>; Thu, 16 Apr 2026 13:06:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C456D3ACF15;
...
X-Spamd-Result: default: False [-2.76 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-6097-lists,linux-api=lfdr.de];
	FROM_HAS_DN(0.00)[];
	...
	MISSING_XM_UA(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[sin.lore.kernel.org:helo,sin.lore.kernel.org:rdns,cyphar.com:mid,cyphar.com:email,cyphar.com:dkim,cyphar.com:url,uapi-group.org:url,amutable.com:email]
X-Rspamd-Queue-Id: 4D81140E747
