...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E6F4B445ACE
	for <lists+linux-api@lfdr.de>; Thu,  4 Nov 2021 20:58:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232063AbhKDUAx (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Thu, 4 Nov 2021 16:00:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34410 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231998AbhKDUAw (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Thu, 4 Nov 2021 16:00:52 -0400
Received: from mail-pf1-x42b.google.com (mail-pf1-x42b.google.com [IPv6:2607:f8b0:4864:20::42b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3A893C061205
        for <linux-api@vger.kernel.org>; Thu,  4 Nov 2021 12:58:14 -0700 (PDT)
Received: by mail-pf1-x42b.google.com with SMTP id x64so6865512pfd.6
        for <linux-api@vger.kernel.org>; Thu, 04 Nov 2021 12:58:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=posk.io; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=YkWDsd7BdvzbdTScL2+EKJL03DgmJY5Paa0TqlMFjn4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=YkWDsd7BdvzbdTScL2+EKJL03DgmJY5Paa0TqlMFjn4=;
        b=
X-Gm-Message-State: AOAM5318TFVRf5ONyRbRq9z9DNYz61rIiuvcFNB2SBjqrCKL6KMytTKO
        JTyJ1GRLePoiEDaZ+08iEOkqWg==
X-Google-Smtp-Source: ABdhPJwh0xvW2MfDjqSQkyI0bVnfx3HA6HDkpNWO265tniVGzWK+W61cEUgBDzza1ktFyaJr7lG0zw==
X-Received: by 2002:a63:af09:: with SMTP id w9mr40022307pge.323.1636055892993;
        Thu, 04 Nov 2021 12:58:12 -0700 (PDT)
Received: from posk-g1.lan (23-118-52-46.lightspeed.sntcca.sbcglobal.net. [23.118.52.46])
        by smtp.gmail.com with ESMTPSA id w185sm5487853pfb.38.2021.11.04.12.58.11
...
Subject: [PATCH v0.8 3/6] sched/umcg: implement UMCG syscalls
Date:   Thu,  4 Nov 2021 12:58:01 -0700
Message-Id: <20211104195804.83240-4-posk@google.com>
...
---
 ...
 kernel/sys_ni.c                        |   4 +
 13 files changed, 1198 insertions(+), 4 deletions(-)
...
index 5f8db54226af..c9b957745e93 100644
...
@@ -2276,6 +2290,63 @@ static inline void rseq_execve(struct task_struct *t)
...
index 000000000000..041027b429dd
--- /dev/null
...
index 763d94c0edf3..22e22c00153f 100644
--- a/kernel/sched/core.c
+++ b/kernel/sched/core.c
@@ -4255,6 +4255,7 @@ static void __sched_fork(unsigned long clone_flags, struct task_struct *p)
...
@@ -6284,9 +6285,11 @@ static inline void sched_submit_work(struct task_struct *tsk)
...
@@ -6304,9 +6307,11 @@ static inline void sched_submit_work(struct task_struct *tsk)
...
new file mode 100644
index 000000000000..6dc940c39644
--- /dev/null
