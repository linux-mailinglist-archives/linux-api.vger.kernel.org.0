...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AF69E2CE388
	for <lists+linux-api@lfdr.de>; Fri,  4 Dec 2020 01:04:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2389110AbgLDAC1 (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Thu, 3 Dec 2020 19:02:27 -0500
Received: from youngberry.canonical.com ([91.189.89.112]:41723 "EHLO
        youngberry.canonical.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2388205AbgLDAC1 (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Thu, 3 Dec 2020 19:02:27 -0500
Received: from ip5f5af0a0.dynamic.kabel-deutschland.de ([95.90.240.160] helo=wittgenstein.fritz.box)
        by youngberry.canonical.com with esmtpsa (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.86_2)
        (envelope-from <christian.brauner@ubuntu.com>)
        id 1kkyXW-0007ka-Ef; Fri, 04 Dec 2020 00:01:34 +0000
...
Subject: [PATCH v4 11/40] namei: make permission helpers idmapped mount aware
Date:   Fri,  4 Dec 2020 00:57:07 +0100
Message-Id: <20201203235736.3528991-12-christian.brauner@ubuntu.com>
...
index 7e8d8169779d..ea4a70850f5e 100644
--- a/fs/btrfs/inode.c
+++ b/fs/btrfs/inode.c
@@ -9852,7 +9852,7 @@ static int btrfs_permission(struct inode *inode, int mask)
...
index 7124c2e8df2f..fdd3d51035b6 100644
--- a/fs/libfs.c
+++ b/fs/libfs.c
...
index 3f52730af6c5..79814dbbfc82 100644
--- a/fs/namei.c
+++ b/fs/namei.c
...
@@ -2507,7 +2553,7 @@ static int lookup_one_len_common(const char *name, struct dentry *base,
 			return err;
 	}
...
+	return inode_permission(&init_user_ns, base->d_inode, MAY_EXEC);
 ...
 /**
@@ -2701,7 +2747,7 @@ static int may_delete(struct inode *dir, struct dentry *victim, bool isdir)
...
+	error = inode_permission(&init_user_ns, dir, MAY_WRITE | MAY_EXEC);
 	if (error)
 		return error;
 	if (IS_APPEND(dir))
@@ -2745,7 +2791,7 @@ static inline int may_create(struct inode *dir, struct dentry *child)
...
+	return inode_permission(&init_user_ns, dir, MAY_WRITE | MAY_EXEC);
 ...
 /*
@@ -2875,7 +2921,7 @@ static int may_open(const struct path *path, int acc_mode, int flag)
 		break;
 	}
...
@@ -2937,7 +2983,8 @@ static int may_o_create(const struct path *dir, struct dentry *dentry, umode_t m
 	    !kgid_has_mapping(s_user_ns, current_fsgid()))
 		return -EOVERFLOW;
...
@@ -3274,7 +3321,7 @@ struct dentry *vfs_tmpfile(struct dentry *dentry, umode_t mode, int open_flag)
 	int error;
...
+	error = inode_permission(&init_user_ns, dir, MAY_WRITE | MAY_EXEC);
 	if (error)
 		goto out_err;
 	error = -EOPNOTSUPP;
@@ -4265,12 +4312,12 @@ int vfs_rename(struct inode *old_dir, struct dentry *old_dentry,
 	 */
 	if (new_dir != old_dir) {
 		if (is_dir) {
...
index b4935793605f..8fb288dd9185 100644
...
index a8d8d48a57fe..bd87d0019266 100644
--- a/mm/madvise.c
+++ b/mm/madvise.c
...
index 29459a6ce1c7..d90f3b72f385 100644
--- a/mm/memcontrol.c
+++ b/mm/memcontrol.c
@@ -4911,7 +4911,7 @@ static ssize_t memcg_write_event_control(struct kernfs_open_file *of,
