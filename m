...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8EEF128DB0D
	for <lists+linux-api@lfdr.de>; Wed, 14 Oct 2020 10:20:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729124AbgJNITl (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Wed, 14 Oct 2020 04:19:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58650 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728979AbgJNITf (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Wed, 14 Oct 2020 04:19:35 -0400
Received: from mail-pf1-x44a.google.com (mail-pf1-x44a.google.com [IPv6:2607:f8b0:4864:20::44a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EB8BAC045869
        for <linux-api@vger.kernel.org>; Tue, 13 Oct 2020 22:51:20 -0700 (PDT)
Received: by mail-pf1-x44a.google.com with SMTP id n85so1187713pfd.6
        for <linux-api@vger.kernel.org>; Tue, 13 Oct 2020 22:51:20 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20161025;
        h=sender:date:message-id:mime-version:subject:from:to:cc;
        bh=UlAgQMDi1J9A3rZxLfmt6ZKrhf1+OKyQ/RdvMwaII8M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:sender:date:message-id:mime-version:subject:from
         :to:cc;
        bh=UlAgQMDi1J9A3rZxLfmt6ZKrhf1+OKyQ/RdvMwaII8M=;
        b=
X-Gm-Message-State: AOAM531SI+qWbU5zxxBBwsbGY/K0UOpxj6vCVziro8UNpg6eKWF6l+zN
        Y7xASjJ8J8R571ysKE6m4PWoEUE=
X-Google-Smtp-Source: ABdhPJxiMBqiRfKdqLfF4bTJG0BtaT6ew2baiDb2qob6n6FCY3e1d7FbUcKl0yDU3wmwXr5DWtk/Sto=
Sender: "pcc via sendgmr" <pcc@pcc-desktop.svl.corp.google.com>
X-Received: from pcc-desktop.svl.corp.google.com ([2620:15c:2ce:0:7220:84ff:fe09:385a])
 (user=pcc job=sendgmr) by 2002:a17:90a:940c:: with SMTP id
 r12mr225985pjo.1.1602654679718; Tue, 13 Oct 2020 22:51:19 -0700 (PDT)
Date:   Tue, 13 Oct 2020 22:51:06 -0700
Message-Id: <20201014055106.25164-1-pcc@google.com>
Mime-Version: 1.0
X-Mailer: git-send-email 2.28.0.1011.ga647a8990f-goog
Subject: [PATCH v2] arm64: Introduce prctl(PR_PAC_{SET,GET}_ENABLED_KEYS)
