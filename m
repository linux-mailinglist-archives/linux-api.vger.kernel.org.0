...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 29CE22FEC01
	for <lists+linux-api@lfdr.de>; Thu, 21 Jan 2021 14:35:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732265AbhAUNec (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Thu, 21 Jan 2021 08:34:32 -0500
Received: from youngberry.canonical.com ([91.189.89.112]:55204 "EHLO
        youngberry.canonical.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1732088AbhAUNc6 (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Thu, 21 Jan 2021 08:32:58 -0500
Received: from ip5f5af0a0.dynamic.kabel-deutschland.de ([95.90.240.160] helo=wittgenstein.fritz.box)
        by youngberry.canonical.com with esmtpsa (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.86_2)
        (envelope-from <christian.brauner@ubuntu.com>)
        id 1l2Zve-0005g7-0J; Thu, 21 Jan 2021 13:23:17 +0000
...
Subject: [PATCH v6 40/40] generic/622: add fstests for idmapped mounts
Date:   Thu, 21 Jan 2021 14:19:59 +0100
Message-Id: <20210121131959.646623-41-christian.brauner@ubuntu.com>
X-Mailer: git-send-email 2.30.0
In-Reply-To: <20210121131959.646623-1-christian.brauner@ubuntu.com>
References: <20210121131959.646623-1-christian.brauner@ubuntu.com>
MIME-Version: 1.0
X-Patch-Hashes: v=1; h=sha256; i=sfpDMgrO/e+92PZxSwxxuWrtR98VRBTv+HXSZAt72dQ=; m=ZyN5xcikfDpUFYU0yak41PKR9Hv32WDJs+gej8CHimM=; p=wd1p0JpeTzke7GJsplxv/Xt0UXjWIjlMsjSyRhJvR+I=; g=3ae29f8c16278c58d88151cc13ca1d76217f5e28
X-Patch-Sig: m=pgp; i=christian.brauner@ubuntu.com; s=0x0x91C61BC06578DCA2; b=iHUEABYKAB0WIQRAhzRXHqcMeLMyaSiRxhvAZXjcogUCYAl9pwAKCRCRxhvAZXjcotieAQC1sg9 INRP2w39wujkJ4w6Dd0jE75ePVsdiEL6ghkgjtQD/fPpIfTboVy7MXAPE0da8i9Nc4QG9odO1BU4r 1CKMvQI=
...
---
 ...
 src/idmapped-mounts/idmapped-mounts.c | 8513 +++++++++++++++++++++++++
 ...
 16 files changed, 8987 insertions(+), 4 deletions(-)
...
index f988a44a..dfe69bf3 100644
--- a/.gitignore
+++ b/.gitignore
@@ -175,6 +175,7 @@
...
+		else
+			ret = fprintf(stderr, "mode(%o):uid(%d):gid(%d) -> %s/%s\n",
+				      (st.st_mode & ~S_IFMT),
...
+		return -1;
+	else
+		ret = log_stderr("mode(%o):uid(%d):gid(%d) -> %s",
+				 (st.st_mode & ~S_IFMT),
...
base-commit: 0e195a4ca997436f4237cb6d21edefb6db1f93d7
-- 
2.30.0
