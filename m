...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6D2FFE2453
	for <lists+linux-api@lfdr.de>; Wed, 23 Oct 2019 22:18:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2405913AbfJWUSG (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Wed, 23 Oct 2019 16:18:06 -0400
Received: from us-smtp-delivery-1.mimecast.com ([207.211.31.120]:57553 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S2405941AbfJWUSE (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Wed, 23 Oct 2019 16:18:04 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1571861882;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=mAR3jWLLwceyOI1YGmnewtsmpk61ffiuSTaVd9UeOEc=;
        b=A+exkiOvNHKuvkb2/5HjmLS2OTP//M8AatXoGzUXo2TucZ9oy8+0l3DHMFNYIBtn/kk//p
        xhRFJkIZ9EndV3ngUSGKzKnL41+UhK3xDaUZBU6jHZWLkYu8cvn4TnSExJO4JmtFWfpUXL
        lSRL1cW5DMhBWYFWz5Tx5G/NWDxpPJo=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-229-K25Bhp62OCCbaB28Qh2ePA-1; Wed, 23 Oct 2019 16:17:58 -0400
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com [10.5.11.23])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id CDA895E4;
        Wed, 23 Oct 2019 20:17:56 +0000 (UTC)
Received: from warthog.procyon.org.uk (ovpn-121-40.rdu2.redhat.com [10.10.121.40])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 7BC1A194B6;
        Wed, 23 Oct 2019 20:17:51 +0000 (UTC)
Organization: Red Hat UK Ltd. Registered Address: Red Hat UK Ltd, Amberley
 Place, 107-111 Peascod Street, Windsor, Berkshire, SI4 1TE, United
 Kingdom.
 Registered in England and Wales under Company Registration No. 3798903
Subject: [RFC PATCH 05/10] pipe: Allow pipes to have kernel-reserved slots
 [ver #2]
...
Date:   Wed, 23 Oct 2019 21:17:50 +0100
Message-ID: <157186187074.3995.5299010277211516015.stgit@warthog.procyon.org.uk>
In-Reply-To: <157186182463.3995.13922458878706311997.stgit@warthog.procyon.org.uk>
References: <157186182463.3995.13922458878706311997.stgit@warthog.procyon.org.uk>
User-Agent: StGit/unknown-version
MIME-Version: 1.0
X-Scanned-By: MIMEDefang 2.84 on 10.5.11.23
X-MC-Unique: K25Bhp62OCCbaB28Qh2ePA-1
...
@@ -1149,9 +1150,10 @@ static long pipe_set_size(struct pipe_inode_info *pi=
...
@@ -1184,7 +1186,7 @@ long pipe_fcntl(struct file *file, unsigned int cmd, =
unsigned long arg)
...
@@ -176,9 +178,11 @@ static inline unsigned int pipe_space_for_user(unsigne=
