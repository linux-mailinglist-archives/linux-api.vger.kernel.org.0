Return-Path: <linux-api+bounces-6825-lists+linux-api=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-api@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id ZB9MHJMFUGoEsAIAu9opvQ
	(envelope-from <linux-api+bounces-6825-lists+linux-api=lfdr.de@vger.kernel.org>)
	for <lists+linux-api@lfdr.de>; Thu, 09 Jul 2026 22:33:23 +0200
X-Original-To: lists+linux-api@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [IPv6:2600:3c09:e001:a7::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id CC141735655
	for <lists+linux-api@lfdr.de>; Thu, 09 Jul 2026 22:33:22 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=rambus.com header.s=selector1 header.b=5hi684nW;
	dmarc=pass (policy=reject) header.from=rambus.com;
	spf=pass (mail.lfdr.de: domain of "linux-api+bounces-6825-lists+linux-api=lfdr.de@vger.kernel.org" designates 2600:3c09:e001:a7::12fc:5321 as permitted sender) smtp.mailfrom="linux-api+bounces-6825-lists+linux-api=lfdr.de@vger.kernel.org";
	arc=reject ("cv is fail on i=2")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 0F18730188A9
	for <lists+linux-api@lfdr.de>; Thu,  9 Jul 2026 20:32:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E262A3E1D08;
	Thu,  9 Jul 2026 20:31:52 +0000 (UTC)
...
Received: from SN4PR2101CU001.outbound.protection.outlook.com (mail-southcentralusazon11022121.outbound.protection.outlook.com [40.93.195.121])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4F57D3C1973;
	Thu,  9 Jul 2026 20:31:28 +0000 (UTC)
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1783629111; cv=fail; b=BEWaYOebzW8evTv2CnK7EAz6jagyXDkF0WkYAz0DMdo4wJUD6zSVUuET5kFLWQV322VyVz7ygZn0B++URwizv7Q1mPwCE4YynK55qfQZ+Le2IANCBiPuzxvlq5h5ikjzUg1AiMp1ciwGtZV56KKOF4QZTbSuC6rnu6qtlPpXL5w=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1783629111; c=relaxed/simple;
	bh=9RmsqhRzqC2aQ7xPvecWE7lQrs9E9g0qNtWxtQSwHcQ=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=aHHF935dtkRj4F1+2qP+qBAfqIPTeoXNrYqenK/OkTOpxZA0jXKzuPQy/GRjKmJnccsU9pBdyAFXbOZpyIUAFd+ws7EYeWCI6ZqJzJYUEQYZ/iwC1qBSw2QyaPuINdjWg+5bHLH/34TkYhKgE7QaYdti/LkBGmuE2uZIv3tEu4M=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=rambus.com; spf=fail smtp.mailfrom=rambus.com; dkim=pass (2048-bit key) header.d=rambus.com header.i=@rambus.com header.b=5hi684nW; arc=fail smtp.client-ip=40.93.195.121
ARC-Seal: i=1; a=rsa-sha256; s=arcselector10001; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector10001;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=cY0AcWNleJGsaUsDx+cOvLWwschIq3wR3WYuD1McYzY=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=rambus.com;
 ...
 bh=cY0AcWNleJGsaUsDx+cOvLWwschIq3wR3WYuD1McYzY=;
 b=
Received: from BN9P221CA0009.NAMP221.PROD.OUTLOOK.COM (2603:10b6:408:10a::17)
 by DSVPR04MB993671.namprd04.prod.outlook.com (2603:10b6:8:420::13) with
 Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.21.181.15; Thu, 9 Jul
 2026 20:31:22 +0000
Received: from BN1PEPF00004686.namprd03.prod.outlook.com
 (2603:10b6:408:10a:cafe::9) by BN9P221CA0009.outlook.office365.com
...
Received: from hqxsv-cmdev3-skrishnamoorthy.rambus.com (hqn-lb-int-float.rambus.com [10.12.20.20])
	by hqxsv-psmtppxy02.rambus.com (Postfix) with ESMTPS id 4FA09180174E;
...
Subject: [PATCH v2 03/19] crypto: cmh - add key provisioning and management
Date: Thu,  9 Jul 2026 13:30:21 -0700
Message-ID: <20260709203037.1884436-4-skrishnamoorthy@rambus.com>
...
X-MS-TrafficTypeDiagnostic: BN1PEPF00004686:EE_|DSVPR04MB993671:EE_
Content-Type: text/plain
X-MS-Office365-Filtering-Correlation-Id: 8d5bd3e3-c161-4a80-6147-08deddf909e5
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam:
	BCL:0;ARA:13230040|376014|7416014|1800799024|82310400026|23010399003|36860700016|11063799006|5023799004|56012099006|22082099003|18002099003|6133799003|3023799007|921020;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:192.86.86.210;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:hqxsv-psmtppxy02.rambus.com;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230040)(376014)(7416014)(1800799024)(82310400026)(23010399003)(36860700016)(11063799006)(5023799004)(56012099006)(22082099003)(18002099003)(6133799003)(3023799007)(921020);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	
X-OriginatorOrg: rambus.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Jul 2026 20:31:21.3376
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 8d5bd3e3-c161-4a80-6147-08deddf909e5
...
X-MS-Exchange-Transport-CrossTenantHeadersStamped: DSVPR04MB993671
...
X-Spamd-Result: default: False [2.84 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-6825-lists,linux-api=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
...
index de065a425a2c..7673ed3e5861 100644
