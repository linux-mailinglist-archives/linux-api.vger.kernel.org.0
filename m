...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5F60F2CE445
	for <lists+linux-api@lfdr.de>; Fri,  4 Dec 2020 01:13:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2502142AbgLDANI (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Thu, 3 Dec 2020 19:13:08 -0500
Received: from youngberry.canonical.com ([91.189.89.112]:43258 "EHLO
        youngberry.canonical.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2389496AbgLDANI (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Thu, 3 Dec 2020 19:13:08 -0500
Received: from ip5f5af0a0.dynamic.kabel-deutschland.de ([95.90.240.160] helo=wittgenstein.fritz.box)
        by youngberry.canonical.com with esmtpsa (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.86_2)
        (envelope-from <christian.brauner@ubuntu.com>)
        id 1kkyYN-0007ka-R4; Fri, 04 Dec 2020 00:02:28 +0000
...
Subject: [PATCH v4 40/40] generic/618: add fstests for idmapped mounts
Date:   Fri,  4 Dec 2020 00:57:36 +0100
Message-Id: <20201203235736.3528991-41-christian.brauner@ubuntu.com>
...
---
 ...
 src/idmapped-mounts/idmapped-mounts.c | 7869 +++++++++++++++++++++++++
 ...
 15 files changed, 8330 insertions(+), 4 deletions(-)
...
+
+		/*
+		 * We're not in_group_p() and capable_wrt_inode_uidgid() so
+		 * setgid bit needs to be set.
+		 */
+		if (is_setgid(open_tree_fd, FILE1, 0))
+			die("failure: is_setgid");
+
