...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 97AB2131588
	for <lists+linux-api@lfdr.de>; Mon,  6 Jan 2020 16:57:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726446AbgAFP5f (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Mon, 6 Jan 2020 10:57:35 -0500
Received: from mail.efficios.com ([167.114.142.138]:33246 "EHLO
        mail.efficios.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726296AbgAFP5f (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Mon, 6 Jan 2020 10:57:35 -0500
Received: from localhost (ip6-localhost [IPv6:::1])
        by mail.efficios.com (Postfix) with ESMTP id D09251EA239;
        Mon,  6 Jan 2020 10:57:30 -0500 (EST)
Received: from mail.efficios.com ([IPv6:::1])
        by localhost (mail02.efficios.com [IPv6:::1]) (amavisd-new, port 10032)
        with ESMTP id Q_JLw0ZmHTXs; Mon,  6 Jan 2020 10:57:29 -0500 (EST)
Received: from localhost (ip6-localhost [IPv6:::1])
        by mail.efficios.com (Postfix) with ESMTP id 4DF901EA1F3;
        Mon,  6 Jan 2020 10:57:24 -0500 (EST)
DKIM-Filter: OpenDKIM Filter v2.10.3 mail.efficios.com 4DF901EA1F3
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=efficios.com;
        s=default; t=1578326244;
        bh=1uQ286fXLmYtBWkZmNHYSM1oIrCIfsUDrWXoREm6KVA=;
        h=From:To:Date:Message-Id;
        b=
X-Virus-Scanned: amavisd-new at efficios.com
Received: from mail.efficios.com ([IPv6:::1])
        by localhost (mail02.efficios.com [IPv6:::1]) (amavisd-new, port 10026)
        with ESMTP id ifDC3RAAPVI6; Mon,  6 Jan 2020 10:57:24 -0500 (EST)
Received: from localhost.localdomain (192-222-181-218.qc.cable.ebox.net [192.222.181.218])
        by mail.efficios.com (Postfix) with ESMTPSA id EA90C1EA187;
        Mon,  6 Jan 2020 10:57:18 -0500 (EST)
...
Subject: [RFC PATCH glibc 09/13] glibc: Perform rseq(2) registration at C startup and thread creation (v13)
Date:   Mon,  6 Jan 2020 10:57:09 -0500
Message-Id: <20200106155713.397-10-mathieu.desnoyers@efficios.com>
...
---
 ...
 44 files changed, 579 insertions(+), 2 deletions(-)
...
index 65140cbc42..e2830450d1 100644
--- a/NEWS
+++ b/NEWS
...
index b220ec526b..253443701c 100644
...
index 502589c330..9da43b393e 100644
