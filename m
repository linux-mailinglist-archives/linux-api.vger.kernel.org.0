...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 779911AF4E6
	for <lists+linux-api@lfdr.de>; Sat, 18 Apr 2020 22:23:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728276AbgDRUW5 (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Sat, 18 Apr 2020 16:22:57 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56942 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1728326AbgDRUWz (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Sat, 18 Apr 2020 16:22:55 -0400
X-Greylist: delayed 6385 seconds by postgrey-1.37 at lindbergh.monkeyblade.net; Sat, 18 Apr 2020 13:22:53 PDT
Received: from hr2.samba.org (hr2.samba.org [IPv6:2a01:4f8:192:486::2:0])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 504CAC061A0C;
        Sat, 18 Apr 2020 13:22:53 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=samba.org;
         s=42; h=Date:Message-ID:From:Cc:To;
        bh=iDWXf6mnu2PKZZ22RH+op9ERPyzdis704u/tCc/Il18=; b=FL1J5YJ73gDKacqHhWE0oxanbl
        
        4psgdbxo6ELCWv69EsSkaAAo;
Received: from [127.0.0.2] (localhost [127.0.0.1])
        by hr2.samba.org with esmtpsa (TLS1.3:ECDHE_RSA_CHACHA20_POLY1305:256)
        (Exim)
        id 1jPtzH-0007hs-Hp; Sat, 18 Apr 2020 20:22:51 +0000
...
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.7.0
MIME-Version: 1.0
In-Reply-To: <CAOssrKe7RNyReAFLoQGBDm79qMdXEubhP5QhG_+UmGZXgeXBkA@mail.gmail.com>
Content-Type: multipart/signed; micalg=pgp-sha512;
 protocol="application/pgp-signature";
 boundary="9ltvmBqMfVcI9ZILfPyjV6Kea8nC7kkqY"
...
--9ltvmBqMfVcI9ZILfPyjV6Kea8nC7kkqY
Content-Type: multipart/mixed; boundary="d0juvCZQKmURXpmOITMiBbdgxDW9caFqR";
...
--d0juvCZQKmURXpmOITMiBbdgxDW9caFqR
Content-Type: text/plain; charset=utf-8
Content-Language: en-US
Content-Transfer-Encoding: quoted-printable

Am 18.04.20 um 21:00 schrieb Miklos Szeredi:
> On Sat, Apr 18, 2020 at 8:36 PM Stefan Metzmacher <metze@samba.org> wro=
te:
>>
>> Hi Miklos,
>>
>>> POSIX defines faccessat() as having a fourth "flags" argument, while =
the
>>> linux syscall doesn't have it.  Glibc tries to emulate AT_EACCESS and=

>>> AT_SYMLINK_NOFOLLOW, but AT_EACCESS emulation is broken.
>>>
>>> Add a new faccessat(2) syscall with the added flags argument and impl=
ement
>>> both flags.
>>>
>>> The value of AT_EACCESS is defined in glibc headers to be the same as=

>>> AT_REMOVEDIR.  Use this value for the kernel interface as well, toget=
her
>>> with the explanatory comment.
>>
>> It would be nice if resolv_flags would also be passed in addition to t=
he
>> at flags.
>> See:https://lore.kernel.org/linux-api/CAHk-=3DwiaL6zznNtCHKg6+MJuCqDxO=
=3DyVfms3qR9A0czjKuSSiA@mail.gmail.com/
>>
...

=49OD
-----END PGP SIGNATURE-----
