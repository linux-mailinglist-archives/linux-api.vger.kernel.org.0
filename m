...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5EFA314CC67
	for <lists+linux-api@lfdr.de>; Wed, 29 Jan 2020 15:27:25 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726683AbgA2O1W (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Wed, 29 Jan 2020 09:27:22 -0500
Received: from hr2.samba.org ([144.76.82.148]:33220 "EHLO hr2.samba.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726261AbgA2O1V (ORCPT <rfc822;linux-api@vger.kernel.org>);
        Wed, 29 Jan 2020 09:27:21 -0500
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=samba.org;
         s=42; h=Date:Message-ID:From:Cc:To;
        bh=9JjVm1QQ3+73oBDwrW0mEjHNzvtM/5vjSbEooKItsUM=; b=kCWMmmhGuvFPbqq4mf2RiwDlSA
        
        +9r3Zx1nrzKDchFHApgn0L9w;
Received: from [127.0.0.2] (localhost [127.0.0.1])
        by hr2.samba.org with esmtpsa (TLS1.3:ECDHE_RSA_CHACHA20_POLY1305:256)
        (Exim)
        id 1iwoJI-00067V-R4; Wed, 29 Jan 2020 14:27:16 +0000
...
Message-ID: <6ebe1e2f-77f4-ae88-e184-c140a911cbd8@samba.org>
Date:   Wed, 29 Jan 2020 15:27:11 +0100
...
Content-Type: multipart/signed; micalg=pgp-sha512;
 ...
 boundary="ZVsCfVoayYRoUhX4w25Ixf0SyELLZG3j3"
...
--ZVsCfVoayYRoUhX4w25Ixf0SyELLZG3j3
Content-Type: multipart/mixed; boundary="5r0GpbJtYryX8qTSoVCWD9vfmpubdHSyQ";
...
>>>>> @@ -3977,7 +3977,8 @@ static int io_req_defer_prep(struct io_kiocb =
*req,
>>>>>  		mmgrab(current->mm);
...
>>> clean this up.
>>
>> As far as I can see it avoids a get_cred() in the IOSQE_PERSONALITY ca=
se
...
> So, that's a bug.
>=20
> It could be I'm wrong with the statement above, need to recheck all thi=
s
> code to be sure.
>=20
...

=MU7k
-----END PGP SIGNATURE-----
