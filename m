...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 99A8E1A9B04
	for <lists+linux-api@lfdr.de>; Wed, 15 Apr 2020 12:42:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2408549AbgDOKY2 (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Wed, 15 Apr 2020 06:24:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57134 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S2896491AbgDOKXv (ORCPT
...
Received: from mo6-p03-ob.smtp.rzone.de (mo6-p03-ob.smtp.rzone.de [IPv6:2a01:238:20a:202:5303::8])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7F87EC03C1AC;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1586946179;
        ...
        bh=xLPdT+S2YQg6rdtioLF/JDenUZcgrQBFNk0M7VvSb7E=;
        b=
X-RZG-AUTH: ":P2ERcEykfu11Y98lp/T7+hdri+uKZK8TKWEqNyiHySGSa9k9xmwdNnzGHXPZIvSaiyU="
X-RZG-CLASS-ID: mo00
Received: from positron.chronox.de
        by smtp.strato.de (RZmta 46.4.0 DYNA|AUTH)
        with ESMTPSA id 404ef0w3FAJk120
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256 bits))
        (Client did not present a certificate);
        Wed, 15 Apr 2020 12:19:46 +0200 (CEST)
...
Subject: [PATCH v30 10/12] LRNG - add SP800-90B compliant health tests
Date:   Wed, 15 Apr 2020 12:14:25 +0200
Message-ID: <9249232.bYct6TBsoo@positron.chronox.de>
