...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 327182C7592
	for <lists+linux-api@lfdr.de>; Sat, 28 Nov 2020 23:24:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387975AbgK1VtR (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Sat, 28 Nov 2020 16:49:17 -0500
Received: from youngberry.canonical.com ([91.189.89.112]:53861 "EHLO
        youngberry.canonical.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2387853AbgK1VrA (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Sat, 28 Nov 2020 16:47:00 -0500
Received: from ip5f5af0a0.dynamic.kabel-deutschland.de ([95.90.240.160] helo=wittgenstein.fritz.box)
        by youngberry.canonical.com with esmtpsa (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.86_2)
        (envelope-from <christian.brauner@ubuntu.com>)
        id 1kj82k-0002aM-La; Sat, 28 Nov 2020 21:46:11 +0000
...
Subject: [PATCH v3 14/38] commoncap: handle idmapped mounts
Date:   Sat, 28 Nov 2020 22:35:03 +0100
Message-Id: <20201128213527.2669807-15-christian.brauner@ubuntu.com>
...
When interacting with user namespace and non-user namespace aware filesystem
capabilities the vfs will perform various security checks to determine whether
or not the filesystem capabilities can be used by the caller (e.g. during exec),
or even whether they need to be removed. The main infrastructure for this
resides in the capability codepaths but they are called through the LSM security
infrastructure even though they are not technically an LSM or optional. This
extends the existing security hooks security_inode_removexattr(),
security_inode_killpriv(), security_inode_getsecurity() to pass down the mount's
user namespace and makes them aware of idmapped mounts.
...
idmapped mount we need to map the root uid according to the mount's user
namespace.
...
mountable inside user namespace the caller can just mount the filesystem
and won't usually need to idmap it. If they do want to idmap it they can create
an idmapped mount and mark it with a user namespace they created and which is
thus a descendant of s_user_ns. For filesystems that are not mountable inside
user namespaces the descendant rule is trivially true because the s_user_ns will
be the initial user namespace.
...
index ab488f0a745a..e86d72608b9f 100644
--- a/fs/attr.c
+++ b/fs/attr.c
...
index 8dba8f0983b5..383dcc1a54a4 100644
--- a/kernel/auditsc.c
+++ b/kernel/auditsc.c
