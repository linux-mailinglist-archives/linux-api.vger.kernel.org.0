...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 201B918B99C
	for <lists+linux-api@lfdr.de>; Thu, 19 Mar 2020 15:41:44 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727634AbgCSOlm (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Thu, 19 Mar 2020 10:41:42 -0400
Received: from mail.efficios.com ([167.114.26.124]:49570 "EHLO
        mail.efficios.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727620AbgCSOll (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Thu, 19 Mar 2020 10:41:41 -0400
Received: from localhost (localhost [127.0.0.1])
        by mail.efficios.com (Postfix) with ESMTP id 11BE8278651;
        Thu, 19 Mar 2020 10:41:39 -0400 (EDT)
Received: from mail.efficios.com ([127.0.0.1])
        by localhost (mail03.efficios.com [127.0.0.1]) (amavisd-new, port 10032)
        with ESMTP id cmCjFOI-kJzD; Thu, 19 Mar 2020 10:41:36 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
        by mail.efficios.com (Postfix) with ESMTP id 407CF27864E;
        Thu, 19 Mar 2020 10:41:34 -0400 (EDT)
DKIM-Filter: OpenDKIM Filter v2.10.3 mail.efficios.com 407CF27864E
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=efficios.com;
        s=default; t=1584628894;
        bh=ZXYyZabtx7ymDgC+NKUdNHfMuYNha8H70aIyTuyJI7Y=;
        h=From:To:Date:Message-Id;
        b=
X-Virus-Scanned: amavisd-new at efficios.com
Received: from mail.efficios.com ([127.0.0.1])
        by localhost (mail03.efficios.com [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id 4qLBzaWrd1Qg; Thu, 19 Mar 2020 10:41:34 -0400 (EDT)
Received: from localhost.localdomain (192-222-181-218.qc.cable.ebox.net [192.222.181.218])
        by mail.efficios.com (Postfix) with ESMTPSA id 86F80278792;
...
Subject: [RFC PATCH glibc 4/8] glibc: Perform rseq(2) registration at C startup and thread creation (v15)
Date:   Thu, 19 Mar 2020 10:41:06 -0400
...
The rseq(2) system call was merged into Linux 4.18.
	...
	* sysdeps/unix/sysv/linux/kernel-features.h: Add __ASSUME_RSEQ.
