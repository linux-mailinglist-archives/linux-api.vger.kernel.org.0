...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7BA5F2CE3AE
	for <lists+linux-api@lfdr.de>; Fri,  4 Dec 2020 01:04:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2389433AbgLDACk (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Thu, 3 Dec 2020 19:02:40 -0500
Received: from youngberry.canonical.com ([91.189.89.112]:41808 "EHLO
        youngberry.canonical.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2388861AbgLDACg (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Thu, 3 Dec 2020 19:02:36 -0500
Received: from ip5f5af0a0.dynamic.kabel-deutschland.de ([95.90.240.160] helo=wittgenstein.fritz.box)
        by youngberry.canonical.com with esmtpsa (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.86_2)
        (envelope-from <christian.brauner@ubuntu.com>)
        id 1kkyXf-0007ka-O2; Fri, 04 Dec 2020 00:01:43 +0000
...
Subject: [PATCH v4 16/40] commoncap: handle idmapped mounts
Date:   Fri,  4 Dec 2020 00:57:12 +0100
Message-Id: <20201203235736.3528991-17-christian.brauner@ubuntu.com>
...
index 8ce654e56b3a..0d1bfeacfa23 100644
--- a/fs/xattr.c
+++ b/fs/xattr.c
...
@@ -298,18 +298,18 @@ vfs_setxattr(struct user_namespace *mnt_userns, struct dentry *dentry,
...
+	len = security_inode_getsecurity(mnt_userns, inode, name, &buffer, true);
 	if (len < 0)
 		return len;
 	if (size < len) {
@@ -399,7 +399,7 @@ vfs_getxattr(struct user_namespace *mnt_userns, struct dentry *dentry,
...
+		int ret = xattr_getsecurity(mnt_userns, inode, suffix, value, size);
 		 ...
 		 * is actually active.
@@ -468,7 +468,7 @@ __vfs_removexattr_locked(struct user_namespace *mnt_userns, struct dentry *dentr
 	if (error)
 		return error;
...
index 61e632677358..09a6a5ffb415 100644
...
index 32a940117e7a..d418b6feaeeb 100644
...
index c503f7ab8afb..94bbac093797 100644
...
index bc2725491560..79230352a1aa 100644
...
index 8e16ec0b3c4b..d91118752e0a 100644
...
@@ -552,7 +563,6 @@ int cap_convert_nscap(struct user_namespace *mnt_userns, struct dentry *dentry,
 	*ivalue = nscap;
 	return newsize;
 }
...
@@ -598,10 +608,24 @@ static inline int bprm_caps_from_vfs_caps(struct cpu_vfs_cap_data *caps,
...
+			   struct cpu_vfs_cap_data *cpu_caps)
 {
 	...
 	__u32 magic_etc;
@@ -657,6 +681,7 @@ int get_vfs_caps_from_disk(const struct dentry *dentry, struct cpu_vfs_cap_data
...
@@ -702,7 +727,7 @@ static int get_file_caps(struct linux_binprm *bprm, struct file *file,
...
@@ -967,16 +992,25 @@ int cap_inode_setxattr(struct dentry *dentry, const char *name,
...
@@ -990,8 +1024,7 @@ int cap_inode_removexattr(struct dentry *dentry, const char *name)
 		struct inode *inode = d_backing_inode(dentry);
 		if (!inode)
 			return -EINVAL;
...
index a28045dc9e7f..66eaa43e386d 100644
...
index 3f42950feed0..7635bb11a8f4 100644
...
index 11003244b18b..66471f81e518 100644
