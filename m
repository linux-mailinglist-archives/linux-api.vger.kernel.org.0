Return-Path: <linux-api+bounces-5698-lists+linux-api=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-api@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id uIg6IB4ycWlQfQAAu9opvQ
	(envelope-from <linux-api+bounces-5698-lists+linux-api=lfdr.de@vger.kernel.org>)
	for <lists+linux-api@lfdr.de>; Wed, 21 Jan 2026 21:07:58 +0100
X-Original-To: lists+linux-api@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [213.196.21.55])
	by mail.lfdr.de (Postfix) with ESMTPS id EDB305CD5C
	for <lists+linux-api@lfdr.de>; Wed, 21 Jan 2026 21:07:57 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id B5B1F70589C
	for <lists+linux-api@lfdr.de>; Wed, 21 Jan 2026 19:58:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8817535CB60;
...
X-Spamd-Result: default: False [0.04 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-5698-lists,linux-api=lfdr.de];
	DMARC_NA(0.00)[landley.net];
	DBL_BLOCKED_OPENRESOLVER(0.00)[ams.mirrors.kernel.org:rdns,ams.mirrors.kernel.org:helo,landley.net:dkim,landley.net:mid,landley.net:url];
	...
	FROM_NEQ_ENVFROM(0.00)[rob@landley.net,linux-api@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
