Return-Path: <linux-api+bounces-6721-lists+linux-api=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-api@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id L7E2EWAZQmqo0AkAu9opvQ
	(envelope-from <linux-api+bounces-6721-lists+linux-api=lfdr.de@vger.kernel.org>)
	for <lists+linux-api@lfdr.de>; Mon, 29 Jun 2026 09:06:08 +0200
X-Original-To: lists+linux-api@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id D27B76D6B5E
	for <lists+linux-api@lfdr.de>; Mon, 29 Jun 2026 09:06:07 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=messagingengine.com header.s=fm1 header.b=IH4WA187;
	spf=pass (mail.lfdr.de: domain of "linux-api+bounces-6721-lists+linux-api=lfdr.de@vger.kernel.org" designates 172.232.135.74 as permitted sender) smtp.mailfrom="linux-api+bounces-6721-lists+linux-api=lfdr.de@vger.kernel.org";
...
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 75576303B658
	for <lists+linux-api@lfdr.de>; Mon, 29 Jun 2026 07:00:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DB2A63BBFAE;
...
X-Spamd-Result: default: False [1.44 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TO_DN_ALL(0.00)[];
	TAGGED_FROM(0.00)[bounces-6721-lists,linux-api=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
