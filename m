...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9A43A2B7520
	for <lists+linux-api@lfdr.de>; Wed, 18 Nov 2020 04:59:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727135AbgKRD6a (ORCPT <rfc822;lists+linux-api@lfdr.de>);
        Tue, 17 Nov 2020 22:58:30 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54736 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725947AbgKRD63 (ORCPT
        <rfc822;linux-api@vger.kernel.org>); Tue, 17 Nov 2020 22:58:29 -0500
Received: from mail-lj1-x244.google.com (mail-lj1-x244.google.com [IPv6:2a00:1450:4864:20::244])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 35122C0613D4
        for <linux-api@vger.kernel.org>; Tue, 17 Nov 2020 19:58:29 -0800 (PST)
Received: by mail-lj1-x244.google.com with SMTP id 11so813406ljf.2
        for <linux-api@vger.kernel.org>; Tue, 17 Nov 2020 19:58:29 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        b=Rc41V2OExekfzzUYqIw2xlpNYY92S2Whio0ZZ1y62rCN9y9Hb4GoGBp8Q4ZR7u6DfE
         OksIi8/M7mU0+45+UK6vLy0Nn86gFJqWnxnPbsMFxR0ey1svww+W/Xtk21bzz8yJ6eRV
         ZDHfGObQ8eOK26wcRLeQZs94/ZNiKiQ/dkmgI=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:references:in-reply-to:from:date
         :message-id:subject:to:cc:content-transfer-encoding;
        bh=c1Vc0T2MGRGBMPGlN5FvourGofnr6xZQBMbuV4i+bDA=;
        b=
X-Gm-Message-State: AOAM532gKUFVm/CWq6rlIM+O4g1tK4P5WpDTSknfJVXUKcAiZ7bvVC5Y
        pixW7qKJmvoxrvckLobsTUglGqaCVqgApfmRF5w=
X-Google-Smtp-Source: ABdhPJz/7WarYT3J9U1UX7Dq0oKEjB5YUvqBQqV9o4dOedx6YmoAV55kmPntSAFRqcWtvAFWfB/Tkg==
X-Received: by 2002:a2e:9083:: with SMTP id l3mr3099841ljg.118.1605671906766;
        Tue, 17 Nov 2020 19:58:26 -0800 (PST)
Received: from mail-lf1-f49.google.com (mail-lf1-f49.google.com. [209.85.167.49])
        by smtp.gmail.com with ESMTPSA id o206sm3369499lfa.278.2020.11.17.19.58.26
        for <linux-api@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Tue, 17 Nov 2020 19:58:26 -0800 (PST)
Received: by mail-lf1-f49.google.com with SMTP id d17so935636lfq.10
        for <linux-api@vger.kernel.org>; Tue, 17 Nov 2020 19:58:26 -0800 (PST)
...
>
> u1001@f2-vm:/$ sudo ./mount-idmapped --map-mount b:1000:1001:1 /home/ubun=
tu/ /mnt
...
> other::r--
>
> 2. Create mapping of the whole ext4 rootfs without a mapping for uid and =
gid 0
>
> ubuntu@f2-vm:~$ sudo /mount-idmapped --map-mount b:1:1:65536 / /mnt/
> ubuntu@f2-vm:~$ findmnt | grep mnt
> =E2=94=94=E2=94=80/mnt                                /dev/sda2  ext4    =
   rw,relatime
>   =E2=94=94=E2=94=80/mnt/mnt                          /dev/sda2  ext4    =
   rw,relatime
> ubuntu@f2-vm:~$ sudo mkdir /AS-ROOT-CAN-CREATE
> ubuntu@f2-vm:~$ sudo mkdir /mnt/AS-ROOT-CANT-CREATE
> mkdir: cannot create directory =E2=80=98/mnt/AS-ROOT-CANT-CREATE=E2=80=99=
...
> ubuntu@f2-vm:/$ findmnt  | grep mnt
> =E2=94=94=E2=94=80/mnt                                /dev/sdb vfat      =
 rw,relatime,fmask=3D0022,dmask=3D0022,codepage=3D437,iocharset=3Diso8859-1=
,shortname=3Dmixed,errors=3Dremount-ro
...
> ubuntu@f2-vm:/$ sudo /mount-idmapped --map-mount b:0:1001:1 /mnt /mnt-100=
1/
...
> ubuntu@f2-vm:/$ sudo /mount-idmapped --map-mount b:0:5000:1 /mnt /mnt-500=
0/
...
> root@f2-vm:~# /mount-idmapped --map-mount b:20000:10000:100000 /var/lib/l=
xc/f2/rootfs/ /mnt
...
> patches for containerd! St=C3=A9phane for his invaluable input on many th=
ings
...
>  create mode 100644 tools/testing/selftests/mount_setattr/mount_setattr_t=
est.c
>
>
